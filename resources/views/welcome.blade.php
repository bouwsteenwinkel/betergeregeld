...
@php
	...
	$services = [
		['slug' => 'cookie-banner-instellen',     'badge' => 'CookieGeregeld',   'title_nl' => 'Cookie banner laten instellen',      'title_en' => 'Cookie banner setup',              'desc_nl' => 'Hulp bij categorieën, scripts, tagging en een nette technische basis voor cookie consent en cookiemeldingen.', 'desc_en' => 'Help with categories, scripts, tagging and a clean technical foundation for cookie consent.'],
		['slug' => 'mail-beveiliging-fix',        'badge' => 'Mail Security',    'title_nl' => 'E-mailbeveiliging instellen',         'title_en' => 'Email security setup',              'desc_nl' => 'Laat SPF, DKIM en DMARC correct instellen en voorkom spamproblemen, spoofing en onbetrouwbare e-mailaflevering.', 'desc_en' => 'SPF, DKIM and DMARC set up correctly to prevent spam issues, spoofing and unreliable email delivery.'],
		['slug' => 'toegang-check',               'badge' => 'Access',           'title_nl' => 'Toegang check',                        'title_en' => 'Access review',                      'desc_nl' => 'Krijg inzicht in accounts, rechten, leveranciers, oude gebruikers en onnodige toegangen binnen je organisatie.', 'desc_en' => 'Insight into accounts, permissions, vendors, stale users and unnecessary access within your organisation.'],
		['slug' => 'website-meertalig-maken',     'badge' => 'Website',          'title_nl' => 'Website meertalig maken',              'title_en' => 'Make website multilingual',          'desc_nl' => 'Laat je website logisch opzetten in meerdere talen met een sterke technische structuur, duidelijke URL-opbouw en SEO-basis.', 'desc_en' => 'Set up your website logically in multiple languages with a strong technical structure, clear URL design and SEO basis.'],
		['slug' => '2fa-implementeren',           'badge' => 'Security',         'title_nl' => '2FA implementeren',                    'title_en' => 'Implement 2FA',                      'desc_nl' => 'Extra loginbeveiliging voor webshop, portal, CMS of beheeromgeving zonder onnodige frictie voor gebruikers.', 'desc_en' => 'Extra login security for webshop, portal, CMS or admin — without unnecessary friction for users.'],
		['slug' => 'seo-check',                   'badge' => 'SEO',              'title_nl' => 'SEO check & optimalisatie',            'title_en' => 'SEO check & optimisation',           'desc_nl' => 'Inzicht in technische SEO, indexatie, headings, metadata, interne links, crawlbaarheid en concrete quick wins.', 'desc_en' => 'Insight into technical SEO: indexation, headings, metadata, internal links, crawlability and concrete quick wins.'],
		['slug' => 'website-snelheid-verbeteren', 'badge' => 'Performance',      'title_nl' => 'Website snelheid verbeteren',          'title_en' => 'Improve website speed',              'desc_nl' => 'Verbeter laadtijd met optimalisaties voor afbeeldingen, scripts, caching, CSS, JavaScript en serverinstellingen.', 'desc_en' => 'Improve loading time with optimisations for images, scripts, caching, CSS, JavaScript and server settings.'],
		['slug' => 'website-onderhoud-uitbesteden','badge' => 'Onderhoud',       'title_nl' => 'Website onderhoud uitbesteden',        'title_en' => 'Outsource website maintenance',      'desc_nl' => 'Laat updates, controles, technisch beheer en basisbeveiliging netjes uitvoeren zonder er zelf achteraan te hoeven.', 'desc_en' => 'Updates, checks, technical management and baseline security handled, without chasing it yourself.'],
		['slug' => 'website-beveiligen',          'badge' => 'Beveiliging',      'title_nl' => 'Website beveiligen',                   'title_en' => 'Secure your website',                'desc_nl' => 'Verklein risico\'s door zwakke instellingen, verouderde plugins, onduidelijke toegang en achterstallig technisch onderhoud aan te pakken.', 'desc_en' => 'Reduce risk by addressing weak settings, outdated plugins, unclear access and overdue technical maintenance.'],
		['slug' => 'website-backup-en-herstel',   'badge' => 'Back-up',          'title_nl' => 'Website back-up en herstel',           'title_en' => 'Website backup & recovery',          'desc_nl' => 'Zorg dat back-up, herstelpunten en recovery-processen goed geregeld zijn zodat fouten, updates of storingen minder impact hebben.', 'desc_en' => 'Make sure backups, restore points and recovery processes are well arranged so mistakes, updates or outages have less impact.'],
		['slug' => 'wordpress-opschonen',         'badge' => 'WordPress',        'title_nl' => 'WordPress opschonen',                  'title_en' => 'Clean up WordPress',                 'desc_nl' => 'Ruim oude plugins, dubbele functies, overbodige code en technische vervuiling op voor meer snelheid en minder risico.', 'desc_en' => 'Clear out old plugins, duplicate functions, redundant code and technical clutter for more speed and less risk.'],
		['slug' => 'website-migratie-zonder-gedoe','badge' => 'Migratie',        'title_nl' => 'Website migratie zonder gedoe',        'title_en' => 'Website migration without hassle',   'desc_nl' => 'Verhuis je website veilig naar nieuwe hosting, server of beheerpartij zonder dataverlies, downtime of technische chaos.', 'desc_en' => 'Move your website safely to new hosting, server or management party without data loss, downtime or chaos.'],
		['slug' => 'website-structuur-check',     'badge' => 'Structuur',        'title_nl' => 'Website structuur check',              'title_en' => 'Website structure check',            'desc_nl' => 'Krijg inzicht in sitemap, URL-structuur, pagina-opbouw, interne links en SEO-basis zodat je website logischer vindbaar wordt.', 'desc_en' => 'Insight into sitemap, URL structure, page composition, internal links and SEO basis to make your site more findable.'],
	];
		...
		<section class="mt-10">
			...
			<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
				@foreach ($services as $s)
					<a href="/{{ $locale }}/diensten/{{ $s['slug'] }}" class="block bg-white border border-[color:var(--color-line)] rounded-[var(--radius-card)] p-5 shadow-[var(--shadow-soft)] hover:-translate-y-0.5 hover:shadow-lg transition">
