...
@section('content')
    ...
    <style>
        .bg-placegrid { display: grid; grid-template-columns: repeat(auto-fit, minmax(min(200px, 100%), 1fr)); gap: 12px; }
        .bg-placegrid > .bg-card { overflow-wrap: anywhere; }
        @media (max-width: 560px) {
            .bg-placegrid { grid-template-columns: repeat(auto-fit, minmax(min(140px, 100%), 1fr)); gap: 10px; }
            .bg-placegrid > .bg-card { padding: 14px 12px !important; font-size: 15px !important; }
    ...
    <section style="padding: 64px calc(50vw - 50%); margin: 0 calc(50% - 50vw); width: 100vw; background: #fff; border-top: 1px solid #E5E3DF;">
        <div style="max-width: 1280px; margin: 0 auto; padding: 0 24px;">
            ...
            <p style="margin: 36px 0 0;"><a href="{{ $site->url('plaatsen') }}" class="bg-alink bg-provback" style="font-size: 16px; font-weight: 700; color: #12386B; text-decoration: none;">&larr; Alle provincies</a></p>
        </div>
    </section>
