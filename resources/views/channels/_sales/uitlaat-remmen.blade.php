@php
    ...
    $landings = (array) config('uitlaat-remmen_landings', []);
...
@section('description', 'Website laten maken voor je uitlaat- en remmenbedrijf: uitlaten, remmen en schokdempers helder op een rij, en afspraken die zo binnenkomen. Gratis voorbeeld.')
    ...
    <section class="hero" data-section="hero">
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    <span class="eyebrow">Voor uitlaat- en remspecialisten</span>
                    <h1>Meer uitlaat- en remklussen uit je eigen regio</h1>
                    ...
                    <ul class="hero-usps">
                        <li>Gevonden worden als iemand een uitlaat vervangen zoekt in jouw regio</li>
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld van een uitlaat- en remmenbedrijf-website" loading="eager" decoding="async"
