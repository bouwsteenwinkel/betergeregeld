@php
    ...
    $landings = (array) config('fotograaf_landings', []);
    $heroImg  = $site->image('hero');
    $heroSet  = $site->imageSrcset('hero');
@endphp
@extends('channels.layout')

@section('title', 'Website of webshop voor je fotografiebedrijf laten maken')
    ...
    <section class="hero" data-section="hero">
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    <span class="eyebrow">Voor jouw fotografiebedrijf</span>
                    ...
                    <ul class="hero-usps">
                        <li>Gevonden worden als iemand een fotograaf zoekt in jouw regio</li>
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld van een fotografiebedrijf-website" loading="eager" decoding="async"
        ...
        <div class="wrap">
            ...
            <div class="grid cols-2 feature-grid" style="margin-top:1.8rem">
                ...
                <div class="feature-card">
                    ...
                    <span class="feature-rule"></span>
                    <p>Wie zoekt op “fotograaf” en jouw plaats, moet jóu vinden. Nu vissen andere bedrijven die klanten voor je neus weg.</p>
                </div>
                <div class="feature-card">
