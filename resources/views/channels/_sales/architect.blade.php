...
@section('description', 'Website laten maken voor je architectenbureau: je projecten in beeld en aanvragen van opdrachtgevers uit je regio. Vraag gratis een voorbeeld van jouw site aan.')
        ...
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    ...
                    <h1>Meer opdrachtgevers voor je architectenbureau</h1>
