@php
    ...
    $landings = (array) config('klusbedrijf_landings', []);
...
@section('content')
    ...
    <section class="hero" data-section="hero">
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    <span class="eyebrow">Voor klusbedrijven</span>
                    <h1>Meer klussen uit je eigen regio</h1>
                    <p class="lead">Een strakke website, online boeking of klantenportaal die klanten binnenhaalt terwijl jij op de klus staat. Wij bouwen 'm, jij bepaalt hoe ver je gaat.</p>
                    ...
                    <ul class="hero-usps">
                        <li>Gevonden worden als iemand een klusser zoekt in jouw regio</li>
                        <li>Aanvragen rechtstreeks in je mailbox</li>
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld van een klusbedrijf-website" loading="eager" decoding="async"
        ...
        <div class="wrap">
            ...
            <div class="grid cols-2 feature-grid" style="margin-top:1.8rem">
                <div class="feature-card">
                    ...
                    <p>Alleen een Facebook-pagina of een site van jaren terug? Dan kiest een klant sneller voor een klusbedrijf dat er strak en betrouwbaar uitziet.</p>
                </div>
                <div class="feature-card">
                    <h3>Je bent niet vindbaar in Google</h3>
                    <span class="feature-rule"></span>
                    <p>Wie zoekt op “klusbedrijf” en jouw plaats, moet jóu vinden. Nu vissen andere bedrijven die klussen voor je neus weg.</p>
                </div>
                <div class="feature-card">
                ...
                <div class="feature-card">
                    ...
                    <span class="feature-rule"></span>
                    <p>Bellen, appen, offertes typen, facturen sturen. Techniek kan een groot deel daarvan van je overnemen.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    @include('channels.partials.groeipad', [
        ...
        'lead'   => 'Van een eerste professionele site tot online boeken en slimme automatisering. Klik op een fase voor het volledige verhaal en een echt voorbeeld.',
    ])

    {{-- Gedeelde aanpak / waarom / CTA --}}
    @include('channels.partials.sales-trust', ['site' => $site, 'ctaTitle' => 'Benieuwd hoe jouw klusbedrijf-site eruit zou zien?'])
