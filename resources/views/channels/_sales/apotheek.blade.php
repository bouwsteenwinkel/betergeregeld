@php
    ...
    $landings = (array) config('apotheek_landings', []);
...
@section('content')
        ...
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    ...
                    <ul class="hero-usps">
                        <li>Gevonden worden als iemand een apotheek zoekt in jouw regio</li>
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld van een apotheek-website" loading="eager" decoding="async"
    ...
    {{-- AI-telefonie: inkomend gesprek als CTA (config apotheek_telefonie.home_cta). --}}
        ...
        <div class="wrap">
            ...
            <div class="grid cols-2 feature-grid" style="margin-top:1.8rem">
                ...
                <div class="feature-card">
                    ...
                    <span class="feature-rule"></span>
                    <p>Wie zoekt op “apotheek” en jouw plaats, moet jóu vinden. Nu vissen andere bedrijven die klanten voor je neus weg.</p>
                </div>
                <div class="feature-card">
