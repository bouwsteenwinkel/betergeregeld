@php
    ...
    $landings = (array) config('loodgieter_landings', []);
    ...
    <section class="hero" data-section="hero">
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    <span class="eyebrow">Voor loodgieters</span>
                    <h1>Meer loodgietersklussen uit je eigen regio</h1>
                    <p class="lead">Een strakke website, webshop of klantenportaal die klanten binnenhaalt terwijl jij op de klus staat. Wij bouwen 'm, jij bepaalt hoe ver je gaat.</p>
                    ...
                    <ul class="hero-usps">
                        <li>Gevonden worden als iemand met spoed een loodgieter zoekt in jouw regio</li>
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld van een loodgieterswebsite" loading="eager" decoding="async"
        ...
        <div class="wrap">
            ...
            <div class="grid cols-2 feature-grid" style="margin-top:1.8rem">
                ...
                <div class="feature-card">
                    ...
                    <span class="feature-rule"></span>
                    <p>Wie zoekt op “loodgieter” en jouw plaats, moet jóu vinden. Nu vissen andere bedrijven die klanten voor je neus weg.</p>
                </div>
                <div class="feature-card">
                    <h3>Aanvragen blijven uit</h3>
                    <span class="feature-rule"></span>
                    <p>Zonder duidelijke bel- en aanvraagknop haakt een geïnteresseerde af. Elke gemiste aanvraag is een misgelopen klus.</p>
                </div>
                <div class="feature-card">
