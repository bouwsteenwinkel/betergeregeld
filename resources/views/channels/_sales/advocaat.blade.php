...
@section('description', 'Website laten maken voor je advocatenkantoor: je rechtsgebieden helder uitgelegd en cliënten die je vinden en contact opnemen. Vraag gratis een voorbeeld aan.')
        ...
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    ...
                    <h1>Meer cliënten voor je advocatenkantoor</h1>
