  ...
  <section id="top" style="padding: 40px 0 64px;">
    <div style="display: flex; flex-wrap: wrap; gap: 56px; align-items: center;">
      <div style="flex: 1 1 400px;">
        <h1 style="font-size: clamp(30px, 4.4vw, 46px); line-height: 1.08; letter-spacing: 0; font-weight: 800; margin: 0 0 14px;">Zie je nieuwe website. Binnen één werkdag.</h1>
  ...
  <section id="werkwijze" style="padding: 72px 0; border-top: 1px solid #E5E3DF;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 40px;">
      <div>
        ...
        <h3 style="font-size: 24px; font-weight: 800; letter-spacing: -0.02em; margin: 0 0 10px;">Binnen één werkdag</h3>
        <p style="font-size: 17px; line-height: 1.5; color: #4A4844; margin: 0;">Vertel in een paar vragen wat je doet en wat de site moet opleveren. We bellen je kort om het scherp te krijgen en maken er een echt voorbeeld van. Binnen één werkdag staat het voor je klaar.</p>
      </div>
      <div>
