@php
    ...
    $landings = (array) config('camperservice_landings', []);
    $heroImg  = $site->image('hero');
    $heroSet  = $site->imageSrcset('hero');
@endphp
@extends('channels.layout')

@section('title', 'Website of webshop voor je camperservicebedrijf laten maken')
@section('description', 'Meer camper-onderhoudsklussen uit je eigen regio met een professionele website, webshop of klantenportaal. Vraag gratis en vrijblijvend een voorbeeld van jouw site aan.')
    ...
    <section class="hero" data-section="hero">
        <div class="wrap">
            <div @if ($heroImg) class="grid cols-2" style="align-items:start;gap:2.6rem" @endif>
                <div>
                    <span class="eyebrow">Voor camperspecialisten</span>
                    <h1>Meer camper-onderhoudsklussen uit je eigen regio</h1>
                    ...
                    <ul class="hero-usps">
                        <li>Gevonden worden als iemand een camperservice zoekt in jouw regio</li>
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld van een camperservicebedrijf-website" loading="eager" decoding="async"
        ...
        <div class="wrap">
            ...
            <div class="grid cols-2 feature-grid" style="margin-top:1.8rem">
                ...
                <div class="feature-card">
                    ...
                    <span class="feature-rule"></span>
                    <p>Wie zoekt op “camperservice” en jouw plaats, moet jóu vinden. Nu vissen andere bedrijven die klanten voor je neus weg.</p>
                </div>
                <div class="feature-card">
