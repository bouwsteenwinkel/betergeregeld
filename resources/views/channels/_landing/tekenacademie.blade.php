@php
    ...
    // $facet = actieve product-facet, $landing = config('tekenacademie_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('tekenacademie_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je tekenacademie'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een tekenacademie" loading="eager" decoding="async"
