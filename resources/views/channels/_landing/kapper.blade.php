@php
    ...
    // $facet = actieve product-facet, $landing = config('kapper_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kapper_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kapsalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kapsalon" loading="eager" decoding="async"
