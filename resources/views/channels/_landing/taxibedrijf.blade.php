@php
    ...
    // $facet = actieve product-facet, $landing = config('taxibedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('taxibedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je taxibedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een taxibedrijf" loading="eager" decoding="async"
