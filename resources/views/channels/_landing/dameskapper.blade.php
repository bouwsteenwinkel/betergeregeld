@php
    ...
    // $facet = actieve product-facet, $landing = config('dameskapper_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dameskapper_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je dameskapsalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een dameskapsalon" loading="eager" decoding="async"
