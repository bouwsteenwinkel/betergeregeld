@php
    ...
    // $facet = actieve product-facet, $landing = config('verhuisbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('verhuisbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je verhuisbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een verhuisbedrijf" loading="eager" decoding="async"
