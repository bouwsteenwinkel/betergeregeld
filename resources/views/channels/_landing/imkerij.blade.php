@php
    ...
    // $facet = actieve product-facet, $landing = config('imkerij_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('imkerij_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je imkerij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een imkerij" loading="eager" decoding="async"
