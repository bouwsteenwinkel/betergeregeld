@php
    ...
    // $facet = actieve product-facet, $landing = config('metselaar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('metselaar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je metselbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een metselbedrijf" loading="eager" decoding="async"
