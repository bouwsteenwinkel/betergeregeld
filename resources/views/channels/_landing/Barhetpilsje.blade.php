@php
    ...
    // $facet = actieve product-facet, $landing = config('Barhetpilsje_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('Barhetpilsje_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je café'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een café" loading="eager" decoding="async"
