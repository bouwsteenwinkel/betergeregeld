@php
    ...
    // $facet = actieve product-facet, $landing = config('touringcarbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('touringcarbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je touringcarbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een touringcarbedrijf" loading="eager" decoding="async"
