@php
    ...
    // $facet = actieve product-facet, $landing = config('boerderijwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('boerderijwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je boerderijwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een boerderijwinkel" loading="eager" decoding="async"
