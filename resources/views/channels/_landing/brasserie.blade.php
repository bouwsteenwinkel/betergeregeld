@php
    ...
    // $facet = actieve product-facet, $landing = config('brasserie_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('brasserie_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je brasserie'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een brasserie" loading="eager" decoding="async"
