@php
    ...
    // $facet = actieve product-facet, $landing = config('koeriersdienst_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('koeriersdienst_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je koeriersdienst'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een koeriersdienst" loading="eager" decoding="async"
