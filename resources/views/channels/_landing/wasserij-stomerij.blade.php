@php
    ...
    // $facet = actieve product-facet, $landing = config('wasserij-stomerij_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('wasserij-stomerij_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je wasserij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een wasserij" loading="eager" decoding="async"
