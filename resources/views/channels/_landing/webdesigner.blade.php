@php
    ...
    // $facet = actieve product-facet, $landing = config('webdesigner_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('webdesigner_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je webdesignbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een webdesignbureau" loading="eager" decoding="async"
