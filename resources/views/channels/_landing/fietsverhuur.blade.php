@php
    ...
    // $facet = actieve product-facet, $landing = config('fietsverhuur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('fietsverhuur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je fietsverhuurbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een fietsverhuurbedrijf" loading="eager" decoding="async"
