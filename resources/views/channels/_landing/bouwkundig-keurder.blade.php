@php
    ...
    // $facet = actieve product-facet, $landing = config('bouwkundig-keurder_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bouwkundig-keurder_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je keuringsbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een keuringsbureau" loading="eager" decoding="async"
