@php
    ...
    // $facet = actieve product-facet, $landing = config('boekhouder_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('boekhouder_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je boekhoudkantoor'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een boekhoudkantoor" loading="eager" decoding="async"
