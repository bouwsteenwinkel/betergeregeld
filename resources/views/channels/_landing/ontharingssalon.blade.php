@php
    ...
    // $facet = actieve product-facet, $landing = config('ontharingssalon_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('ontharingssalon_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je ontharingssalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een ontharingssalon" loading="eager" decoding="async"
