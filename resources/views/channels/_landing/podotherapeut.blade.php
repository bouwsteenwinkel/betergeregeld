@php
    ...
    // $facet = actieve product-facet, $landing = config('podotherapeut_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('podotherapeut_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je podotherapiepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een podotherapiepraktijk" loading="eager" decoding="async"
