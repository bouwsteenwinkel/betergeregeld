@php
    ...
    // $facet = actieve product-facet, $landing = config('vertaler_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('vertaler_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je vertaalbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een vertaalbureau" loading="eager" decoding="async"
