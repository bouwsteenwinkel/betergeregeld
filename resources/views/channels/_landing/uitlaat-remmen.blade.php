@php
    ...
    // $facet = actieve product-facet, $landing = config('uitlaat-remmen_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('uitlaat-remmen_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je uitlaat- en remmenbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een uitlaat- en remmenbedrijf" loading="eager" decoding="async"
