@php
    ...
    // $facet = actieve product-facet, $landing = config('hondentrimsalon_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('hondentrimsalon_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je trimsalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een trimsalon" loading="eager" decoding="async"
