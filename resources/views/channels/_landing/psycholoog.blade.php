@php
    ...
    // $facet = actieve product-facet, $landing = config('psycholoog_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('psycholoog_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je psychologenpraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een psychologenpraktijk" loading="eager" decoding="async"
