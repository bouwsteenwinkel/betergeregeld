@php
    ...
    // $facet = actieve product-facet, $landing = config('meubelzaak_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('meubelzaak_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je meubelzaak'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een meubelzaak" loading="eager" decoding="async"
