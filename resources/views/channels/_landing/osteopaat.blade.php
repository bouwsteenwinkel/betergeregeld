@php
    ...
    // $facet = actieve product-facet, $landing = config('osteopaat_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('osteopaat_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je osteopathiepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een osteopathiepraktijk" loading="eager" decoding="async"
