@php
    ...
    // $facet = actieve product-facet, $landing = config('vve-beheer_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('vve-beheer_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je vve-beheerbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een vve-beheerbedrijf" loading="eager" decoding="async"
