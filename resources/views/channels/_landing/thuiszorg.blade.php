@php
    ...
    // $facet = actieve product-facet, $landing = config('thuiszorg_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('thuiszorg_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je thuiszorgorganisatie'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een thuiszorgorganisatie" loading="eager" decoding="async"
