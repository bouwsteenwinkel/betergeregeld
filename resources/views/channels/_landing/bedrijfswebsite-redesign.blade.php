@php
    ...
    // $facet = actieve product-facet, $landing = config('bedrijfswebsite-redesign_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bedrijfswebsite-redesign_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bedrijf" loading="eager" decoding="async"
