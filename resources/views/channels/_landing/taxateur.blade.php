@php
    ...
    // $facet = actieve product-facet, $landing = config('taxateur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('taxateur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je taxatiebureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een taxatiebureau" loading="eager" decoding="async"
