@php
    ...
    // $facet = actieve product-facet, $landing = config('bijlesbureau_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bijlesbureau_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bijlesbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bijlesbureau" loading="eager" decoding="async"
