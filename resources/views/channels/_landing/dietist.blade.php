@php
    ...
    // $facet = actieve product-facet, $landing = config('dietist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dietist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je diëtistenpraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een diëtistenpraktijk" loading="eager" decoding="async"
