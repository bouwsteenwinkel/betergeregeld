@php
    ...
    // $facet = actieve product-facet, $landing = config('elektricien_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('elektricien_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je elektrabedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een elektrabedrijf" loading="eager" decoding="async"
