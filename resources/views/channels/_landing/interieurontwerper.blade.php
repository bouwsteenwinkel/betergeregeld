@php
    ...
    // $facet = actieve product-facet, $landing = config('interieurontwerper_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('interieurontwerper_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je interieurstudio'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een interieurstudio" loading="eager" decoding="async"
