@php
    ...
    // $facet = actieve product-facet, $landing = config('dakkapel-specialist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dakkapel-specialist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je dakkapelbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een dakkapelbedrijf" loading="eager" decoding="async"
