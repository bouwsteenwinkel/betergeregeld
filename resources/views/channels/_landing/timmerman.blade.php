@php
    ...
    // $facet = actieve product-facet, $landing = config('timmerman_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('timmerman_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je timmerbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een timmerbedrijf" loading="eager" decoding="async"
