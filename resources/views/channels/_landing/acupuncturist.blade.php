@php
    ...
    // $facet = actieve product-facet, $landing = config('acupuncturist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('acupuncturist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je acupunctuurpraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een acupunctuurpraktijk" loading="eager" decoding="async"
