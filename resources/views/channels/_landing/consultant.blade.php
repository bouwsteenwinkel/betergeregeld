@php
    ...
    // $facet = actieve product-facet, $landing = config('consultant_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('consultant_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je adviesbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een adviesbureau" loading="eager" decoding="async"
