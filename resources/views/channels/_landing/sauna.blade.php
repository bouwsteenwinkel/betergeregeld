@php
    ...
    // $facet = actieve product-facet, $landing = config('sauna_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('sauna_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je sauna'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een sauna" loading="eager" decoding="async"
