@php
    ...
    // $facet = actieve product-facet, $landing = config('rioolontstopper_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('rioolontstopper_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je rioolservicebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een rioolservicebedrijf" loading="eager" decoding="async"
