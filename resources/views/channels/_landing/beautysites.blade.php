@php
    ...
    // $facet = actieve product-facet, $landing = config('beautysites_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('beautysites_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je schoonheidssalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een schoonheidssalon" loading="eager" decoding="async"
