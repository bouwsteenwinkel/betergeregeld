@php
    ...
    // $facet = actieve product-facet, $landing = config('kringloopwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kringloopwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kringloopwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kringloopwinkel" loading="eager" decoding="async"
