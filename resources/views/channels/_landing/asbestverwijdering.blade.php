@php
    ...
    // $facet = actieve product-facet, $landing = config('asbestverwijdering_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('asbestverwijdering_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je asbestbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een asbestbedrijf" loading="eager" decoding="async"
