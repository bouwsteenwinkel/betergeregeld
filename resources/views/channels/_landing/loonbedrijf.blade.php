@php
    ...
    // $facet = actieve product-facet, $landing = config('loonbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('loonbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je loonbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een loonbedrijf" loading="eager" decoding="async"
