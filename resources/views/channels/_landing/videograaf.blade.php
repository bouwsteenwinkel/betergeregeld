@php
    ...
    // $facet = actieve product-facet, $landing = config('videograaf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('videograaf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je videobedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een videobedrijf" loading="eager" decoding="async"
