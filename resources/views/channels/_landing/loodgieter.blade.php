@php
    ...
    // $facet = actieve product-facet, $landing = config('loodgieter_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('loodgieter_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je loodgietersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een loodgietersbedrijf" loading="eager" decoding="async"
