@php
    ...
    // $facet = actieve product-facet, $landing = config('apotheek_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('apotheek_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je apotheek'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een apotheek" loading="eager" decoding="async"
