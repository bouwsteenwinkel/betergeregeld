@php
    ...
    // $facet = actieve product-facet, $landing = config('woonwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('woonwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je woonwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een woonwinkel" loading="eager" decoding="async"
