@php
    ...
    // $facet = actieve product-facet, $landing = config('autobedrijf-occasions_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('autobedrijf-occasions_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je autobedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een autobedrijf" loading="eager" decoding="async"
