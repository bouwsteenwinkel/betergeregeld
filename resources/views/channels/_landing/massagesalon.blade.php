@php
    ...
    // $facet = actieve product-facet, $landing = config('massagesalon_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('massagesalon_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je massagesalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een massagesalon" loading="eager" decoding="async"
