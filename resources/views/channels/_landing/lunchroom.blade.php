@php
    ...
    // $facet = actieve product-facet, $landing = config('lunchroom_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('lunchroom_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je lunchroom'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een lunchroom" loading="eager" decoding="async"
