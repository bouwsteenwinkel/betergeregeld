@php
    ...
    // $facet = actieve product-facet, $landing = config('car-detailing_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('car-detailing_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je detailingbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een detailingbedrijf" loading="eager" decoding="async"
