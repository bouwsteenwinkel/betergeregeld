@php
    ...
    // $facet = actieve product-facet, $landing = config('grafisch-ontwerper_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('grafisch-ontwerper_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je ontwerpstudio'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een ontwerpstudio" loading="eager" decoding="async"
