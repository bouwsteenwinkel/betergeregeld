@php
    ...
    // $facet = actieve product-facet, $landing = config('cateraar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('cateraar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je cateringbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een cateringbedrijf" loading="eager" decoding="async"
