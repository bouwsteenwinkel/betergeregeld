@php
    ...
    // $facet = actieve product-facet, $landing = config('klimhal_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('klimhal_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je klimhal'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een klimhal" loading="eager" decoding="async"
