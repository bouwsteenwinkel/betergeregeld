@php
    ...
    // $facet = actieve product-facet, $landing = config('zonnestudio_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('zonnestudio_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je zonnestudio'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een zonnestudio" loading="eager" decoding="async"
