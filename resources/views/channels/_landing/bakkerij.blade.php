@php
    ...
    // $facet = actieve product-facet, $landing = config('bakkerij_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bakkerij_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bakkerij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bakkerij" loading="eager" decoding="async"
