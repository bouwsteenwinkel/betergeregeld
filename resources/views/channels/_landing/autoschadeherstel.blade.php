@php
    ...
    // $facet = actieve product-facet, $landing = config('autoschadeherstel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('autoschadeherstel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je autoschadebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een autoschadebedrijf" loading="eager" decoding="async"
