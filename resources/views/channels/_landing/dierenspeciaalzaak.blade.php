@php
    ...
    // $facet = actieve product-facet, $landing = config('dierenspeciaalzaak_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dierenspeciaalzaak_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je dierenspeciaalzaak'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een dierenspeciaalzaak" loading="eager" decoding="async"
