@php
    ...
    // $facet = actieve product-facet, $landing = config('cafetaria_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('cafetaria_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je cafetaria'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een cafetaria" loading="eager" decoding="async"
