@php
    ...
    // $facet = actieve product-facet, $landing = config('permanente-make-up_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('permanente-make-up_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je pmu-studio'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een pmu-studio" loading="eager" decoding="async"
