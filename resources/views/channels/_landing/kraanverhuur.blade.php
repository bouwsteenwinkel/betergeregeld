@php
    ...
    // $facet = actieve product-facet, $landing = config('kraanverhuur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kraanverhuur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kraanverhuurbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kraanverhuurbedrijf" loading="eager" decoding="async"
