@php
    ...
    // $facet = actieve product-facet, $landing = config('glaszetter_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('glaszetter_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je glaszettersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een glaszettersbedrijf" loading="eager" decoding="async"
