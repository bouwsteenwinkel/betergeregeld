@php
    ...
    // $facet = actieve product-facet, $landing = config('pretpark_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('pretpark_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je pretpark'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een pretpark" loading="eager" decoding="async"
