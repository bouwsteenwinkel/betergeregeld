@php
    ...
    // $facet = actieve product-facet, $landing = config('partycentrum_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('partycentrum_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je partycentrum'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een partycentrum" loading="eager" decoding="async"
