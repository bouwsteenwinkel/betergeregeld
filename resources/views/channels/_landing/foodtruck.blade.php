@php
    ...
    // $facet = actieve product-facet, $landing = config('foodtruck_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('foodtruck_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je foodtruck'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een foodtruck" loading="eager" decoding="async"
