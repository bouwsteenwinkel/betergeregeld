@php
    ...
    // $facet = actieve product-facet, $landing = config('vakantiepark_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('vakantiepark_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je vakantiepark'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een vakantiepark" loading="eager" decoding="async"
