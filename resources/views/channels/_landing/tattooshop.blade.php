@php
    ...
    // $facet = actieve product-facet, $landing = config('tattooshop_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('tattooshop_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je tattooshop'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een tattooshop" loading="eager" decoding="async"
