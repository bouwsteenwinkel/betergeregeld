@php
    ...
    // $facet = actieve product-facet, $landing = config('marketingbureau_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('marketingbureau_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je marketingbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een marketingbureau" loading="eager" decoding="async"
