@php
    ...
    // $facet = actieve product-facet, $landing = config('nagelsites_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('nagelsites_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je nagelsalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een nagelsalon" loading="eager" decoding="async"
