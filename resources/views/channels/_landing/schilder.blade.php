@php
    ...
    // $facet = actieve product-facet, $landing = config('schilder_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('schilder_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je schildersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een schildersbedrijf" loading="eager" decoding="async"
