@php
    ...
    // $facet = actieve product-facet, $landing = config('visagist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('visagist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je visagiepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een visagiepraktijk" loading="eager" decoding="async"
