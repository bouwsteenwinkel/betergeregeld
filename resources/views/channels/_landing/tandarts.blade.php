@php
    ...
    // $facet = actieve product-facet, $landing = config('tandarts_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('tandarts_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je tandartspraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een tandartspraktijk" loading="eager" decoding="async"
