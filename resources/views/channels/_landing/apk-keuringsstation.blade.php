@php
    ...
    // $facet = actieve product-facet, $landing = config('apk-keuringsstation_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('apk-keuringsstation_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je apk-keuringsstation'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een apk-keuringsstation" loading="eager" decoding="async"
