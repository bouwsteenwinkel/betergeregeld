@php
    ...
    // $facet = actieve product-facet, $landing = config('bestratingsbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bestratingsbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bestratingsbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bestratingsbedrijf" loading="eager" decoding="async"
