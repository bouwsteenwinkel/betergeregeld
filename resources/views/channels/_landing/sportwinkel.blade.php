@php
    ...
    // $facet = actieve product-facet, $landing = config('sportwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('sportwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je sportwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een sportwinkel" loading="eager" decoding="async"
