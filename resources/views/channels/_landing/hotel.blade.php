@php
    ...
    // $facet = actieve product-facet, $landing = config('hotel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('hotel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je hotel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een hotel" loading="eager" decoding="async"
