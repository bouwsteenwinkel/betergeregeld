@php
    ...
    // $facet = actieve product-facet, $landing = config('vastgoedbeheer_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('vastgoedbeheer_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je vastgoedbeheerbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een vastgoedbeheerbedrijf" loading="eager" decoding="async"
