@php
    ...
    // $facet = actieve product-facet, $landing = config('bowlingcentrum_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bowlingcentrum_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bowlingcentrum'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bowlingcentrum" loading="eager" decoding="async"
