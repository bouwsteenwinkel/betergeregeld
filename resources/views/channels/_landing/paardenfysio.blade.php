@php
    ...
    // $facet = actieve product-facet, $landing = config('paardenfysio_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('paardenfysio_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je paardenfysiopraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een paardenfysiopraktijk" loading="eager" decoding="async"
