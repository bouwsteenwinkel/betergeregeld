@php
    ...
    // $facet = actieve product-facet, $landing = config('herenkapper_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('herenkapper_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je herenkapsalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een herenkapsalon" loading="eager" decoding="async"
