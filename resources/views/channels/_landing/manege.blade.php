@php
    ...
    // $facet = actieve product-facet, $landing = config('manege_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('manege_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je manege'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een manege" loading="eager" decoding="async"
