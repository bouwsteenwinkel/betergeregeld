@php
    ...
    // $facet = actieve product-facet, $landing = config('administratiekantoor_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('administratiekantoor_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je administratiekantoor'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een administratiekantoor" loading="eager" decoding="async"
