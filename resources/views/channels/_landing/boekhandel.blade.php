@php
    ...
    // $facet = actieve product-facet, $landing = config('boekhandel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('boekhandel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je boekhandel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een boekhandel" loading="eager" decoding="async"
