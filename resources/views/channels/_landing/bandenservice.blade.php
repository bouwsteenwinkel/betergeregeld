@php
    ...
    // $facet = actieve product-facet, $landing = config('bandenservice_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bandenservice_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bandenservicebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bandenservicebedrijf" loading="eager" decoding="async"
