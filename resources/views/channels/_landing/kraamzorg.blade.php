@php
    ...
    // $facet = actieve product-facet, $landing = config('kraamzorg_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kraamzorg_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kraamzorgbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kraamzorgbureau" loading="eager" decoding="async"
