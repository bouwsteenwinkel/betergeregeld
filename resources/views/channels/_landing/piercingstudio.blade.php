@php
    ...
    // $facet = actieve product-facet, $landing = config('piercingstudio_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('piercingstudio_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je piercingstudio'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een piercingstudio" loading="eager" decoding="async"
