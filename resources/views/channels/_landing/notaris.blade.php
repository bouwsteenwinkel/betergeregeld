@php
    ...
    // $facet = actieve product-facet, $landing = config('notaris_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('notaris_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je notariskantoor'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een notariskantoor" loading="eager" decoding="async"
