@php
    ...
    // $facet = actieve product-facet, $landing = config('orthodontist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('orthodontist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je orthodontiepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een orthodontiepraktijk" loading="eager" decoding="async"
