@php
    ...
    // $facet = actieve product-facet, $landing = config('autogarage_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('autogarage_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je garagebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een garagebedrijf" loading="eager" decoding="async"
