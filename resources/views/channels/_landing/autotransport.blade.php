@php
    ...
    // $facet = actieve product-facet, $landing = config('autotransport_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('autotransport_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je autotransportbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een autotransportbedrijf" loading="eager" decoding="async"
