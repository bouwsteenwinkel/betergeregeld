@php
    ...
    // $facet = actieve product-facet, $landing = config('strandtent_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('strandtent_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je strandtent'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een strandtent" loading="eager" decoding="async"
