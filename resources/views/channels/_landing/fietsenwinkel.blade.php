@php
    ...
    // $facet = actieve product-facet, $landing = config('fietsenwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('fietsenwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je fietsenwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een fietsenwinkel" loading="eager" decoding="async"
