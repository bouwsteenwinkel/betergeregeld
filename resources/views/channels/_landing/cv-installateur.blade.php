@php
    ...
    // $facet = actieve product-facet, $landing = config('cv-installateur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('cv-installateur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je installatiebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een installatiebedrijf" loading="eager" decoding="async"
