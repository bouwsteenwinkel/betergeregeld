@php
    ...
    // $facet = actieve product-facet, $landing = config('aanhangwagenspecialist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('aanhangwagenspecialist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je aanhangwagenbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een aanhangwagenbedrijf" loading="eager" decoding="async"
