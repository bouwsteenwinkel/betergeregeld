@php
    ...
    // $facet = actieve product-facet, $landing = config('sportschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('sportschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je sportschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een sportschool" loading="eager" decoding="async"
