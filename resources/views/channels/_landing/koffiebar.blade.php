@php
    ...
    // $facet = actieve product-facet, $landing = config('koffiebar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('koffiebar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je koffiebar'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een koffiebar" loading="eager" decoding="async"
