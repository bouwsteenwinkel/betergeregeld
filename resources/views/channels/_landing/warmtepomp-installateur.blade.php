@php
    ...
    // $facet = actieve product-facet, $landing = config('warmtepomp-installateur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('warmtepomp-installateur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je warmtepompbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een warmtepompbedrijf" loading="eager" decoding="async"
