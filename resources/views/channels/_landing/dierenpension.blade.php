@php
    ...
    // $facet = actieve product-facet, $landing = config('dierenpension_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dierenpension_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je dierenpension'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een dierenpension" loading="eager" decoding="async"
