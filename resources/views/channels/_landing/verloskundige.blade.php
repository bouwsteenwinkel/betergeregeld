@php
    ...
    // $facet = actieve product-facet, $landing = config('verloskundige_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('verloskundige_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je verloskundigenpraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een verloskundigenpraktijk" loading="eager" decoding="async"
