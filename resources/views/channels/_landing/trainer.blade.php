@php
    ...
    // $facet = actieve product-facet, $landing = config('trainer_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('trainer_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je trainingsbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een trainingsbureau" loading="eager" decoding="async"
