@php
    ...
    // $facet = actieve product-facet, $landing = config('brow-bar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('brow-bar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je browbar'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een browbar" loading="eager" decoding="async"
