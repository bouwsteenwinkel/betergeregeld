@php
    ...
    // $facet = actieve product-facet, $landing = config('slijterij_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('slijterij_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je slijterij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een slijterij" loading="eager" decoding="async"
