@php
    ...
    // $facet = actieve product-facet, $landing = config('architect_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('architect_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je architectenbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een architectenbureau" loading="eager" decoding="async"
