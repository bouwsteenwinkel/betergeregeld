@php
    ...
    // $facet = actieve product-facet, $landing = config('vechtsportschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('vechtsportschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je vechtsportschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een vechtsportschool" loading="eager" decoding="async"
