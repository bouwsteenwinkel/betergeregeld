@php
    ...
    // $facet = actieve product-facet, $landing = config('slagerij_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('slagerij_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je slagerij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een slagerij" loading="eager" decoding="async"
