@php
    ...
    // $facet = actieve product-facet, $landing = config('ijssalon_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('ijssalon_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je ijssalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een ijssalon" loading="eager" decoding="async"
