@php
    ...
    // $facet = actieve product-facet, $landing = config('bedrijfsmakelaar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bedrijfsmakelaar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bedrijfsmakelaar'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bedrijfsmakelaar" loading="eager" decoding="async"
