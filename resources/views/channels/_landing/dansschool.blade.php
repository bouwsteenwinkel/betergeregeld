@php
    ...
    // $facet = actieve product-facet, $landing = config('dansschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dansschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je dansschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een dansschool" loading="eager" decoding="async"
