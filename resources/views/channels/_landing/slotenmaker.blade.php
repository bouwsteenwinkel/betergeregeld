@php
    ...
    // $facet = actieve product-facet, $landing = config('slotenmaker_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('slotenmaker_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je slotenmakersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een slotenmakersbedrijf" loading="eager" decoding="async"
