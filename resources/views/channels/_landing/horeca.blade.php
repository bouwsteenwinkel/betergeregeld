@php
    ...
    // $facet = actieve product-facet, $landing = config('horeca_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('horeca_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je horecazaak'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een horecazaak" loading="eager" decoding="async"
