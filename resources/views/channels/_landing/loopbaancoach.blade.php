@php
    ...
    // $facet = actieve product-facet, $landing = config('loopbaancoach_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('loopbaancoach_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je loopbaanadviesbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een loopbaanadviesbureau" loading="eager" decoding="async"
