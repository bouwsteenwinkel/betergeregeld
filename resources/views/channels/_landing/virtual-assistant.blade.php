@php
    ...
    // $facet = actieve product-facet, $landing = config('virtual-assistant_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('virtual-assistant_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je virtual-assistancebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een virtual-assistancebedrijf" loading="eager" decoding="async"
