@php
    ...
    // $facet = actieve product-facet, $landing = config('grillroom_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('grillroom_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je grillroom'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een grillroom" loading="eager" decoding="async"
