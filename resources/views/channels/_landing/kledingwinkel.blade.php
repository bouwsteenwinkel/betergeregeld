@php
    ...
    // $facet = actieve product-facet, $landing = config('kledingwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kledingwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kledingwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kledingwinkel" loading="eager" decoding="async"
