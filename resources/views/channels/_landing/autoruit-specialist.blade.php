@php
    ...
    // $facet = actieve product-facet, $landing = config('autoruit-specialist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('autoruit-specialist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je autoruitbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een autoruitbedrijf" loading="eager" decoding="async"
