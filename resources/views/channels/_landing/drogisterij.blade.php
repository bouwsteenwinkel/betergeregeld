@php
    ...
    // $facet = actieve product-facet, $landing = config('drogisterij_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('drogisterij_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je drogisterij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een drogisterij" loading="eager" decoding="async"
