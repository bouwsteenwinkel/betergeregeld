@php
    ...
    // $facet = actieve product-facet, $landing = config('reisbureau_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('reisbureau_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je reisbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een reisbureau" loading="eager" decoding="async"
