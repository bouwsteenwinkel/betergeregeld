@php
    ...
    // $facet = actieve product-facet, $landing = config('aankoopmakelaar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('aankoopmakelaar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je aankoopmakelaar'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een aankoopmakelaar" loading="eager" decoding="async"
