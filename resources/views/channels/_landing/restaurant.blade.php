@php
    ...
    // $facet = actieve product-facet, $landing = config('restaurant_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('restaurant_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je restaurant'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een restaurant" loading="eager" decoding="async"
