@php
    ...
    // $facet = actieve product-facet, $landing = config('makelaar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('makelaar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je makelaarskantoor'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een makelaarskantoor" loading="eager" decoding="async"
