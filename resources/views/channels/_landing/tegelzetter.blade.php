@php
    ...
    // $facet = actieve product-facet, $landing = config('tegelzetter_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('tegelzetter_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je tegelzettersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een tegelzettersbedrijf" loading="eager" decoding="async"
