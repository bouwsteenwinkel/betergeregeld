@php
    ...
    // $facet = actieve product-facet, $landing = config('zonwering-specialist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('zonwering-specialist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je zonweringbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een zonweringbedrijf" loading="eager" decoding="async"
