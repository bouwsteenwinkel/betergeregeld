@php
    ...
    // $facet = actieve product-facet, $landing = config('garagedeuren-specialist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('garagedeuren-specialist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je garagedeurenbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een garagedeurenbedrijf" loading="eager" decoding="async"
