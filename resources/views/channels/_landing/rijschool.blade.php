@php
    ...
    // $facet = actieve product-facet, $landing = config('rijschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('rijschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je rijschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een rijschool" loading="eager" decoding="async"
