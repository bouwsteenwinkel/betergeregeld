@php
    ...
    // $facet = actieve product-facet, $landing = config('padelclub_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('padelclub_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je padelclub'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een padelclub" loading="eager" decoding="async"
