@php
    ...
    // $facet = actieve product-facet, $landing = config('schoenenwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('schoenenwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je schoenenwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een schoenenwinkel" loading="eager" decoding="async"
