@php
    ...
    // $facet = actieve product-facet, $landing = config('indoor-speelparadijs_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('indoor-speelparadijs_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je speelparadijs'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een speelparadijs" loading="eager" decoding="async"
