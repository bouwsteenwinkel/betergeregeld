@php
    ...
    // $facet = actieve product-facet, $landing = config('gastouderbureau_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('gastouderbureau_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je gastouderbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een gastouderbureau" loading="eager" decoding="async"
