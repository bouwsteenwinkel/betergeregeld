@php
    ...
    // $facet = actieve product-facet, $landing = config('kinderopvang_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kinderopvang_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kinderopvang'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kinderopvang" loading="eager" decoding="async"
