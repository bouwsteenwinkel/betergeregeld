@php
    ...
    // $facet = actieve product-facet, $landing = config('vloerenlegger_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('vloerenlegger_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je vloerenbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een vloerenbedrijf" loading="eager" decoding="async"
