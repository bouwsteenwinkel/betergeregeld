@php
    ...
    // $facet = actieve product-facet, $landing = config('bootcamp_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bootcamp_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bootcampbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bootcampbedrijf" loading="eager" decoding="async"
