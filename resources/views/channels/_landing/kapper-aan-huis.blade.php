@php
    ...
    // $facet = actieve product-facet, $landing = config('kapper-aan-huis_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kapper-aan-huis_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kappersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kappersbedrijf" loading="eager" decoding="async"
