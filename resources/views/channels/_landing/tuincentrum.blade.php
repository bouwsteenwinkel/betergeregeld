@php
    ...
    // $facet = actieve product-facet, $landing = config('tuincentrum_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('tuincentrum_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je tuincentrum'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een tuincentrum" loading="eager" decoding="async"
