@php
    ...
    // $facet = actieve product-facet, $landing = config('camping_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('camping_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je camping'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een camping" loading="eager" decoding="async"
