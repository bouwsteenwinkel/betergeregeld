@php
    ...
    // $facet = actieve product-facet, $landing = config('interieurbouwer_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('interieurbouwer_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je interieurbouwbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een interieurbouwbedrijf" loading="eager" decoding="async"
