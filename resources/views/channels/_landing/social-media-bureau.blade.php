@php
    ...
    // $facet = actieve product-facet, $landing = config('social-media-bureau_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('social-media-bureau_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je socialmediabureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een socialmediabureau" loading="eager" decoding="async"
