@php
    ...
    // $facet = actieve product-facet, $landing = config('dierenarts_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dierenarts_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je dierenartspraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een dierenartspraktijk" loading="eager" decoding="async"
