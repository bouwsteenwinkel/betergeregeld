@php
    ...
    // $facet = actieve product-facet, $landing = config('bed-breakfast_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bed-breakfast_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bed & breakfast'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bed & breakfast" loading="eager" decoding="async"
