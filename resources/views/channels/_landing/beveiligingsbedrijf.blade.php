@php
    ...
    // $facet = actieve product-facet, $landing = config('beveiligingsbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('beveiligingsbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je beveiligingsbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een beveiligingsbedrijf" loading="eager" decoding="async"
