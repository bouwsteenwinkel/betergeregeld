@php
    ...
    // $facet = actieve product-facet, $landing = config('ongediertebestrijding_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('ongediertebestrijding_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je ongediertebestrijder'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een ongediertebestrijder" loading="eager" decoding="async"
