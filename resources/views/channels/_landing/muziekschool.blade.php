@php
    ...
    // $facet = actieve product-facet, $landing = config('muziekschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('muziekschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je muziekschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een muziekschool" loading="eager" decoding="async"
