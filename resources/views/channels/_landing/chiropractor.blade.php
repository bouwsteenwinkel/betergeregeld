@php
    ...
    // $facet = actieve product-facet, $landing = config('chiropractor_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('chiropractor_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je chiropractiepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een chiropractiepraktijk" loading="eager" decoding="async"
