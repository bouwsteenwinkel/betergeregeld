@php
    ...
    // $facet = actieve product-facet, $landing = config('grondverzet_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('grondverzet_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je grondverzetbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een grondverzetbedrijf" loading="eager" decoding="async"
