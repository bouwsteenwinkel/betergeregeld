@php
    ...
    // $facet = actieve product-facet, $landing = config('hoefsmid_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('hoefsmid_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je hoefsmederij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een hoefsmederij" loading="eager" decoding="async"
