@php
    ...
    // $facet = actieve product-facet, $landing = config('cadeauwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('cadeauwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je cadeauwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een cadeauwinkel" loading="eager" decoding="async"
