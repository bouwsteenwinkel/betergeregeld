@php
    ...
    // $facet = actieve product-facet, $landing = config('dakdekker_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('dakdekker_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je dakdekkersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een dakdekkersbedrijf" loading="eager" decoding="async"
