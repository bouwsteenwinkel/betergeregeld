@php
    ...
    // $facet = actieve product-facet, $landing = config('crossfit-box_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('crossfit-box_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je crossfit-box'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een crossfit-box" loading="eager" decoding="async"
