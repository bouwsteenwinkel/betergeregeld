@php
    ...
    // $facet = actieve product-facet, $landing = config('businesscoach_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('businesscoach_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je coachpraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een coachpraktijk" loading="eager" decoding="async"
