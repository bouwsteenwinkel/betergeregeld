@php
    ...
    // $facet = actieve product-facet, $landing = config('hovenier_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('hovenier_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je hoveniersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een hoveniersbedrijf" loading="eager" decoding="async"
