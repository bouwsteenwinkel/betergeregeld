@php
    ...
    // $facet = actieve product-facet, $landing = config('sloopbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('sloopbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je sloopbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een sloopbedrijf" loading="eager" decoding="async"
