@php
    ...
    // $facet = actieve product-facet, $landing = config('pilatesstudio_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('pilatesstudio_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je pilatesstudio'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een pilatesstudio" loading="eager" decoding="async"
