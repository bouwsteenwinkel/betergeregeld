@php
    ...
    // $facet = actieve product-facet, $landing = config('auto-airco-service_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('auto-airco-service_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je auto-aircobedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een auto-aircobedrijf" loading="eager" decoding="async"
