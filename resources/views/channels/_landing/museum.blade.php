@php
    ...
    // $facet = actieve product-facet, $landing = config('museum_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('museum_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je museum'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een museum" loading="eager" decoding="async"
