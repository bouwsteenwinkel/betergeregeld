@php
    ...
    // $facet = actieve product-facet, $landing = config('aannemer_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('aannemer_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je aannemersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een aannemersbedrijf" loading="eager" decoding="async"
