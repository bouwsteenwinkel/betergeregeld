@php
    ...
    // $facet = actieve product-facet, $landing = config('bezorgrestaurant_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bezorgrestaurant_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bezorgrestaurant'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bezorgrestaurant" loading="eager" decoding="async"
