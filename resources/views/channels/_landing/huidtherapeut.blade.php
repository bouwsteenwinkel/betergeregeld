@php
    ...
    // $facet = actieve product-facet, $landing = config('huidtherapeut_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('huidtherapeut_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je huidtherapiepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een huidtherapiepraktijk" loading="eager" decoding="async"
