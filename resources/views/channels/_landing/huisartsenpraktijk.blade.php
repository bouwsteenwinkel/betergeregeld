@php
    ...
    // $facet = actieve product-facet, $landing = config('huisartsenpraktijk_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('huisartsenpraktijk_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je huisartsenpraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een huisartsenpraktijk" loading="eager" decoding="async"
