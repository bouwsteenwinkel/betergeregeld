@php
    ...
    // $facet = actieve product-facet, $landing = config('golfschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('golfschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je golfschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een golfschool" loading="eager" decoding="async"
