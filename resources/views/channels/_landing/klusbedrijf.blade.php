@php
    ...
    // $facet = actieve product-facet, $landing = config('klusbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('klusbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je klusbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een klusbedrijf" loading="eager" decoding="async"
