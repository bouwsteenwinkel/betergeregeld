@php
    ...
    // $facet = actieve product-facet, $landing = config('speelgoedwinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('speelgoedwinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je speelgoedwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een speelgoedwinkel" loading="eager" decoding="async"
