@php
    ...
    // $facet = actieve product-facet, $landing = config('isolatiebedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('isolatiebedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je isolatiebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een isolatiebedrijf" loading="eager" decoding="async"
