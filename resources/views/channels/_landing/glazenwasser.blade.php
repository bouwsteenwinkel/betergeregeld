@php
    ...
    // $facet = actieve product-facet, $landing = config('glazenwasser_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('glazenwasser_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je glazenwassersbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een glazenwassersbedrijf" loading="eager" decoding="async"
