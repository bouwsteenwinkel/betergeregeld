@php
    ...
    // $facet = actieve product-facet, $landing = config('fysiotherapeut_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('fysiotherapeut_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je fysiopraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een fysiopraktijk" loading="eager" decoding="async"
