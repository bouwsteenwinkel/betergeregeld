@php
    ...
    // $facet = actieve product-facet, $landing = config('escape-room_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('escape-room_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je escaperoom'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een escaperoom" loading="eager" decoding="async"
