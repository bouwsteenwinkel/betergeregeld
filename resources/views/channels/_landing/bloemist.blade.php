@php
    ...
    // $facet = actieve product-facet, $landing = config('bloemist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('bloemist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je bloemenwinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een bloemenwinkel" loading="eager" decoding="async"
