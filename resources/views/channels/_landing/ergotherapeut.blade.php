@php
    ...
    // $facet = actieve product-facet, $landing = config('ergotherapeut_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('ergotherapeut_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je ergotherapiepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een ergotherapiepraktijk" loading="eager" decoding="async"
