@php
    ...
    // $facet = actieve product-facet, $landing = config('tennisschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('tennisschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je tennisschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een tennisschool" loading="eager" decoding="async"
