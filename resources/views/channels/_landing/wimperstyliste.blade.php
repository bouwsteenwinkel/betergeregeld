@php
    ...
    // $facet = actieve product-facet, $landing = config('wimperstyliste_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('wimperstyliste_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je wimpersalon'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een wimpersalon" loading="eager" decoding="async"
