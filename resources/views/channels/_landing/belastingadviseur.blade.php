@php
    ...
    // $facet = actieve product-facet, $landing = config('belastingadviseur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('belastingadviseur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je belastingadvieskantoor'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een belastingadvieskantoor" loading="eager" decoding="async"
