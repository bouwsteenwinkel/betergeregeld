@php
    ...
    // $facet = actieve product-facet, $landing = config('mondhygienist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('mondhygienist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je mondhygiënepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een mondhygiënepraktijk" loading="eager" decoding="async"
