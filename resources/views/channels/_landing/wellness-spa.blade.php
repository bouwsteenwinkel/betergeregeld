@php
    ...
    // $facet = actieve product-facet, $landing = config('wellness-spa_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('wellness-spa_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je wellnesscentrum'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een wellnesscentrum" loading="eager" decoding="async"
