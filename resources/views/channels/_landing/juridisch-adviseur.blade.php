@php
    ...
    // $facet = actieve product-facet, $landing = config('juridisch-adviseur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('juridisch-adviseur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je juridisch adviesbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een juridisch adviesbureau" loading="eager" decoding="async"
