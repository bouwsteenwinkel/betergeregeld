@php
    ...
    // $facet = actieve product-facet, $landing = config('airco-installateur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('airco-installateur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je aircobedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een aircobedrijf" loading="eager" decoding="async"
