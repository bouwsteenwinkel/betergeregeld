@php
    ...
    // $facet = actieve product-facet, $landing = config('juwelier_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('juwelier_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je juwelier'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een juwelier" loading="eager" decoding="async"
