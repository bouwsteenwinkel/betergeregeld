@php
    ...
    // $facet = actieve product-facet, $landing = config('verhuurmakelaar_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('verhuurmakelaar_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je verhuurmakelaar'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een verhuurmakelaar" loading="eager" decoding="async"
