@php
    ...
    // $facet = actieve product-facet, $landing = config('self-storage_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('self-storage_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je opslagbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een opslagbedrijf" loading="eager" decoding="async"
