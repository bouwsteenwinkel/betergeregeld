@php
    ...
    // $facet = actieve product-facet, $landing = config('opticien_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('opticien_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je opticien'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een opticien" loading="eager" decoding="async"
