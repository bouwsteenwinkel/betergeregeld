@php
    ...
    // $facet = actieve product-facet, $landing = config('kozijnenbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kozijnenbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kozijnenbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kozijnenbedrijf" loading="eager" decoding="async"
