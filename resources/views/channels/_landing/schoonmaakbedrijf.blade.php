@php
    ...
    // $facet = actieve product-facet, $landing = config('schoonmaakbedrijf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('schoonmaakbedrijf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je schoonmaakbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een schoonmaakbedrijf" loading="eager" decoding="async"
