@php
    ...
    // $facet = actieve product-facet, $landing = config('tekstschrijver_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('tekstschrijver_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je tekstbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een tekstbureau" loading="eager" decoding="async"
