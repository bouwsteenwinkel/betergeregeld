@php
    ...
    // $facet = actieve product-facet, $landing = config('pedicure_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('pedicure_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je pedicurepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een pedicurepraktijk" loading="eager" decoding="async"
