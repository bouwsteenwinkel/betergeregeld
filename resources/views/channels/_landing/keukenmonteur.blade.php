@php
    ...
    // $facet = actieve product-facet, $landing = config('keukenmonteur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('keukenmonteur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je keukenmontagebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een keukenmontagebedrijf" loading="eager" decoding="async"
