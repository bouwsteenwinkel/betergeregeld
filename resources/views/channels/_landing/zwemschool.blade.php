@php
    ...
    // $facet = actieve product-facet, $landing = config('zwemschool_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('zwemschool_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je zwemschool'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een zwemschool" loading="eager" decoding="async"
