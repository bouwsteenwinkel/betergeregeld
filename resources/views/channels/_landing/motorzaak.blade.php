@php
    ...
    // $facet = actieve product-facet, $landing = config('motorzaak_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('motorzaak_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je motorbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een motorbedrijf" loading="eager" decoding="async"
