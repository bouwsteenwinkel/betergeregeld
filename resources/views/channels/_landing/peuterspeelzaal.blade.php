@php
    ...
    // $facet = actieve product-facet, $landing = config('peuterspeelzaal_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('peuterspeelzaal_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je peuterspeelzaal'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een peuterspeelzaal" loading="eager" decoding="async"
