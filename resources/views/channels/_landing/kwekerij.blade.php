@php
    ...
    // $facet = actieve product-facet, $landing = config('kwekerij_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kwekerij_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kwekerij'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kwekerij" loading="eager" decoding="async"
