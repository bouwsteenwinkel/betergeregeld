@php
    ...
    // $facet = actieve product-facet, $landing = config('personal-trainer_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('personal-trainer_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je personal-trainingsbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een personal-trainingsbedrijf" loading="eager" decoding="async"
