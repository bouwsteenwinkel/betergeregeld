@php
    ...
    // $facet = actieve product-facet, $landing = config('pizzeria_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('pizzeria_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je pizzeria'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een pizzeria" loading="eager" decoding="async"
