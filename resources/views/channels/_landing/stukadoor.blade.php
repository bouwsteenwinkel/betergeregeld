@php
    ...
    // $facet = actieve product-facet, $landing = config('stukadoor_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('stukadoor_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je stukadoorsbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een stukadoorsbedrijf" loading="eager" decoding="async"
