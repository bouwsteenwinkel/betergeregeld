@php
    ...
    // $facet = actieve product-facet, $landing = config('fotograaf_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('fotograaf_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je fotografiebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een fotografiebedrijf" loading="eager" decoding="async"
