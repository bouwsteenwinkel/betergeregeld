@php
    ...
    // $facet = actieve product-facet, $landing = config('uitvaartverzorger_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('uitvaartverzorger_landings', []));
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een uitvaartonderneming" loading="eager" decoding="async"
