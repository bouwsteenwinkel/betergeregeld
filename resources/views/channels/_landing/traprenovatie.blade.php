@php
    ...
    // $facet = actieve product-facet, $landing = config('traprenovatie_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('traprenovatie_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je traprenovatiebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een traprenovatiebedrijf" loading="eager" decoding="async"
