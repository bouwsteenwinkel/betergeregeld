@php
    ...
    // $facet = actieve product-facet, $landing = config('camperservice_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('camperservice_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je camperservicebedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een camperservicebedrijf" loading="eager" decoding="async"
