@php
    ...
    // $facet = actieve product-facet, $landing = config('kaaswinkel_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('kaaswinkel_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je kaaswinkel'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een kaaswinkel" loading="eager" decoding="async"
