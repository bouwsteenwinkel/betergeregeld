@php
    ...
    // $facet = actieve product-facet, $landing = config('optometrist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('optometrist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je optometriepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een optometriepraktijk" loading="eager" decoding="async"
