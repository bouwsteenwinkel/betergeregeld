@php
    ...
    // $facet = actieve product-facet, $landing = config('yogastudio_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('yogastudio_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je yogastudio'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een yogastudio" loading="eager" decoding="async"
