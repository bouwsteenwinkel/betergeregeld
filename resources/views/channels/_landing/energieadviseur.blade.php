@php
    ...
    // $facet = actieve product-facet, $landing = config('energieadviseur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('energieadviseur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je energieadviesbureau'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een energieadviesbureau" loading="eager" decoding="async"
