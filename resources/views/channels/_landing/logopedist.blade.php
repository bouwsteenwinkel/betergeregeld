@php
    ...
    // $facet = actieve product-facet, $landing = config('logopedist_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('logopedist_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je logopediepraktijk'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een logopediepraktijk" loading="eager" decoding="async"
