@php
    ...
    // $facet = actieve product-facet, $landing = config('advocaat_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('advocaat_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je advocatenkantoor'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een advocatenkantoor" loading="eager" decoding="async"
