@php
    ...
    // $facet = actieve product-facet, $landing = config('zonnepanelen-installateur_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('zonnepanelen-installateur_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je zonnepanelenbedrijf'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een zonnepanelenbedrijf" loading="eager" decoding="async"
