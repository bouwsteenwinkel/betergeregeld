@php
    ...
    // $facet = actieve product-facet, $landing = config('barbersites_landings.'.$facet),
    ...
    $landingKeys = array_keys((array) config('barbersites_landings', []));
...
@section('title', $site->landingTitle($hero['title'] ?? null, $fLabel, 'voor je barbershop'))
                ...
                @if ($heroImg)
                    <div>
                        <img src="{{ $heroImg }}"
                             ...
                             alt="Voorbeeld voor een barbershop" loading="eager" decoding="async"
