...
/**
 * Productverhalen voor de camperservice-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de camperservicebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je camperservicebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand camperonderhoud, reparatie of ombouw zoekt, en laat met een strakke site je service en vakwerk zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je onderhoud, reparatie en ombouw meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een camperservice zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Een camper is een dierbaar bezit. Je site laat je onderhoud, reparatie en ombouw zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'CamperCare',
      'heroTitle' => 'Camper onderhouden of ombouwen? Vakkundig geregeld',
      'urlLabel' => 'jouw-camperservicebedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je camperservicebedrijf, naast je werk',
      'sub' => 'Verkoop camperaccessoires en onderdelen online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast onderhouden ook accessoires leveren? Klanten bestellen zelf onderdelen en accessoires, betalen met iDEAL of op rekening en boeken montage bij.',
      'brand' => 'CamperCare',
      'heroTitle' => 'Bestel camperaccessoires online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-camperservicebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-camperservicebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je camperservicebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-camperservicebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je camperservicebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je aan een camper aan het werk, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een camperservicebedrijf.',
      'brand' => 'CamperCare',
