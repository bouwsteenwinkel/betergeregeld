...
/**
 * Productverhalen voor de glaszetter-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de glaszettersbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je glaszettersbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand met een gebroken ruit of nieuw glas zit, en laat met een strakke site je spoedservice en vakwerk zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je spoedservice bij glasschade meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een glaszetter zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je glaswerk en je spoedservice online',
      'intro' => 'Een gebroken ruit is spoed. Je site laat je bereikbaarheid, je vakwerk en je glasopties zien, zodat een klant met een gerust hart meteen jóu belt.',
      'brand' => 'GlasVast',
      'heroTitle' => 'Gebroken ruit of nieuw glas? Snel en vakkundig geregeld',
      'urlLabel' => 'jouw-glaszettersbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent geplaatst glaswerk',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je glaszettersbedrijf, naast je werk',
      'sub' => 'Verkoop glas op maat, spiegels en beslag online, met plaatsing bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast plaatsen ook glas op maat leveren? Klanten bestellen zelf hun maat, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'GlasVast',
      'heroTitle' => 'Bestel glas op maat online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-glaszettersbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-glaszettersbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je glaszettersbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-glaszettersbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je glaszettersbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je een ruit aan het zetten, dan kun je niet opnemen. De assistent vangt de spoedmelding op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een glaszettersbedrijf.',
      'brand' => 'GlasVast',
