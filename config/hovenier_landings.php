...
/**
 * Productverhalen voor de hovenier-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de hoveniersbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je hoveniersbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een tuin wil laten aanleggen of onderhouden, en laat met een strakke site je mooiste tuinen zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je mooiste tuinen in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een hovenier zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je tuinen online',
      'intro' => 'Een tuin is zichtbaar vakwerk. Je site laat je aangelegde tuinen en tevreden klanten zien, zodat een opdrachtgever meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'GroenWerk',
      'heroTitle' => 'Van ontwerp tot aangelegde tuin, in één hand',
      'urlLabel' => 'jouw-hoveniersbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent aangelegde tuinen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je hoveniersbedrijf, naast je werk',
      'sub' => 'Verkoop planten, sierbestrating en tuinmateriaal online, met aanleg bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast aanleggen ook planten en materiaal leveren? Klanten bestellen zelf, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'GroenWerk',
      'heroTitle' => 'Bestel planten en tuinmateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-hoveniersbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-hoveniersbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je hoveniersbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-hoveniersbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je hoveniersbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je in een tuin te werken, dan gaat de klus vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een hoveniersbedrijf.',
      'brand' => 'GroenWerk',
