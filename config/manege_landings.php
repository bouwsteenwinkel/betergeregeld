...
/**
 * Productverhalen voor de manege-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de manege. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je manege die klanten oplevert',
      'sub' => 'Word gevonden als iemand paardrijlessen of pension zoekt, en laat met een strakke site je lessen, faciliteiten en sfeer zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je lessen, pension en tarieven meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een manege zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je lessen en je inschrijvingen online',
      'intro' => 'Een manege kies je op sfeer en vertrouwen. Je site laat je lessen, faciliteiten en online inschrijven zien, zodat een ruiter met een gerust hart voor jou kiest.',
      'brand' => 'Manegepro',
      'heroTitle' => 'Leren paardrijden of stalling zoeken? Schrijf je online in',
      'urlLabel' => 'jouw-manege.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Een kijkje op de manege',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je manege, naast je werk',
      'sub' => 'Verkoop lidmaatschappen, lessenkaarten en ruitersport online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast lesgeven ook kaarten en producten aanbieden? Klanten kopen zelf een lessenkaart of ruitersport, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'Manegepro',
      'heroTitle' => 'Koop je lessenkaart of ruitersport online',
      'urlLabel' => 'shop.jouw-manege.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je manege',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je manege die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je in de bak les te geven, dan gaat de bellende klant vaak naar een andere manege. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een manege.',
      'brand' => 'Manegepro',
