...
/**
 * Productverhalen voor de schilder-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de schildersbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je schildersbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een schilder zoekt binnen of buiten, en laat met een strakke site je strakke afwerking en projecten zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je geschilderde projecten in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een schilder zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je schilderwerk online',
      'intro' => 'Schilderwerk verkoopt op het oog. Je site laat je afgeronde projecten en strakke afwerking zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'VerfVak',
      'heroTitle' => 'Binnen of buiten: strak schilderwerk, netjes opgeleverd',
      'urlLabel' => 'jouw-schildersbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent geschilderde projecten',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je schildersbedrijf, naast je werk',
      'sub' => 'Verkoop verf, kwasten en materiaal online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast schilderen ook verf leveren? Klanten bestellen zelf verf en materiaal in jouw kleuradvies, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'VerfVak',
      'heroTitle' => 'Bestel verf en materiaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-schildersbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-schildersbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je schildersbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-schildersbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je schildersbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op een ladder te schilderen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een schildersbedrijf.',
      'brand' => 'VerfVak',
