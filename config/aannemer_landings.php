...
/**
 * Productverhalen voor de aannemer-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de aannemersbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je aannemersbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een verbouwing of nieuwbouw plant in jouw regio, en laat met een strakke site zien dat je afspraken nakomt en netjes oplevert.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je mooiste projecten in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een aannemer zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je vakwerk en je opleveringen online',
      'intro' => 'Een verbouwing is vertrouwen geven. Je site laat je afgeronde projecten en tevreden klanten zien, zodat een opdrachtgever met een gerust hart voor jou kiest. We hebben een compleet voorbeeld klaargezet.',
      'brand' => 'BouwStroom',
      'heroTitle' => 'Van eerste schets tot opgeleverd project, in één hand',
      'urlLabel' => 'jouw-aannemersbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent opgeleverde projecten',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je aannemersbedrijf, naast je werk',
      'sub' => 'Verkoop bouwmaterialen, pakketten of klein materieel online. Zakelijke klanten bestellen op rekening.',
    ...
    array (
      ...
      'intro' => 'Naast bouwen ook materialen leveren? Klanten en collega-aannemers bestellen zelf, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'BouwStroom',
      'heroTitle' => 'Bestel bouwmaterialen online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-aannemersbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-aannemersbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je aannemersbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-aannemersbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je aannemersbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op de bouw, dan gaat een nieuwe opdracht vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een aannemersbedrijf.',
      'brand' => 'BouwStroom',
