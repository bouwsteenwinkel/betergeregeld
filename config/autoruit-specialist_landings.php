...
/**
 * Productverhalen voor de autoruit-specialist-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de autoruitbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je autoruitbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een ster of gebroken ruit heeft, en laat met een strakke site je snelle service en verzekeringsgemak zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je spoedservice en verzekeringsafhandeling meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een autoruit vervangen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Ruitschade is spoed en gedoe met de verzekering. Je site laat je snelle service en verzekeringsafhandeling zien, zodat een klant meteen jóu kiest.',
      'brand' => 'RuitFix',
      'heroTitle' => 'Ster of gebroken ruit? Snel gemaakt, verzekering geregeld',
      'urlLabel' => 'jouw-autoruitbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent vervangen ruiten',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je autoruitbedrijf, naast je werk',
      'sub' => 'Verkoop ruitreparatiesets, wissers en toebehoren online, met plaatsing bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast vervangen ook producten leveren? Klanten bestellen zelf wissers en reparatiesets, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'RuitFix',
      'heroTitle' => 'Bestel ruitproducten online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-autoruitbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-autoruitbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je autoruitbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-autoruitbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je autoruitbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je een ruit aan het zetten, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een autoruitbedrijf.',
      'brand' => 'RuitFix',
