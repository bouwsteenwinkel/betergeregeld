...
/**
 * Productverhalen voor de autobedrijf-occasions-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de autobedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je autobedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een occasion zoekt in jouw regio, en laat met een strakke site je voorraad met foto\'s en prijzen zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je hele voorraad met foto\'s en prijzen online',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een occasions zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je voorraad 24/7 online',
      'intro' => 'Een occasion koop je op vertrouwen en beeld. Je site laat je voorraad, foto\'s en prijzen zien, zodat een koper al overtuigd is voordat hij langskomt.',
      'brand' => 'OccasionPro',
      'heroTitle' => 'Je volgende auto? Bekijk de voorraad en plan een proefrit',
      'urlLabel' => 'jouw-autobedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent verkochte occasions',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je autobedrijf, naast je werk',
      'sub' => 'Toon je hele occasionvoorraad online, met foto\'s, prijs en de mogelijkheid om een proefrit te reserveren.',
    ...
    array (
      ...
      'intro' => 'Je showroom is 24/7 open. Kopers bekijken je voorraad, zien foto\'s en prijzen en reserveren zelf een proefrit, ook \'s avonds en in het weekend.',
      'brand' => 'OccasionPro',
      'heroTitle' => 'Bekijk de voorraad en reserveer een proefrit',
      'urlLabel' => 'shop.jouw-autobedrijf.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Uitgelicht in de voorraad',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-autobedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je autobedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-autobedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je autobedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Help je een klant in de showroom, dan gaat de bellende koper vaak naar een ander. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een autobedrijf.',
      'brand' => 'OccasionPro',
