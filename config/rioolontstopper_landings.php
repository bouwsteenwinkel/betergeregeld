...
/**
 * Productverhalen voor de rioolontstopper-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de rioolservicebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je rioolservicebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand met spoed een verstopping heeft, en laat met een strakke site je 24/7 service en vaste prijs zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je 24/7 spoedservice en vaste prijs meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een rioolontstopper zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je spoedservice online',
      'intro' => 'Een verstopping is spoed. Je site laat je bereikbaarheid, je vaste prijs en je werkwijze zien, zodat een klant met een gerust hart meteen jóu belt.',
      'brand' => 'RioolVlot',
      'heroTitle' => 'Verstopping of rioolprobleem? Vandaag nog verholpen',
      'urlLabel' => 'jouw-rioolservicebedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je rioolservicebedrijf, naast je werk',
      'sub' => 'Verkoop ontstoppingsmateriaal en preventiemiddelen online, met inspectie bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast ontstoppen ook middelen leveren? Klanten bestellen zelf ontstoppers en putdeksels, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'RioolVlot',
      'heroTitle' => 'Bestel ontstoppingsmateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-rioolservicebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-rioolservicebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je rioolservicebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-rioolservicebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je rioolservicebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Zit je met je arm in een put, dan kun je niet opnemen. De assistent vangt de spoedmelding op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een rioolservicebedrijf.',
      'brand' => 'RioolVlot',
