...
/**
 * Productverhalen voor de autoschadeherstel-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de autoschadebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je autoschadebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand schade heeft en herstel zoekt, en laat met een strakke site je vakwerk en verzekeringsgemak zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je vakwerk en verzekeringsafhandeling meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een autoschade herstellen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je vakwerk en je service online',
      'intro' => 'Schadeherstel draait om vertrouwen. Je site laat je voor-en-na resultaten, je vervangend vervoer en verzekeringsafhandeling zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'PlaatPro',
      'heroTitle' => 'Schade aan je auto? Vakkundig hersteld, verzekering geregeld',
      'urlLabel' => 'jouw-autoschadebedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent hersteld: voor en na',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je autoschadebedrijf, naast je werk',
      'sub' => 'Verkoop poets- en herstelproducten online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Met een webshop op rekening bestellen collega\'s en bedrijven voortaan bij jou.',
      ),
    ),
    'zkhw' => 
    array (
      ...
      'intro' => 'Naast herstellen ook producten leveren? Klanten bestellen zelf polish en herstelmiddelen, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'PlaatPro',
      'heroTitle' => 'Bestel herstelproducten online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-autoschadebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-autoschadebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je autoschadebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-autoschadebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je autoschadebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je aan het plaatwerken of spuiten, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een autoschadebedrijf.',
      'brand' => 'PlaatPro',
