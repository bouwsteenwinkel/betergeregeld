...
/**
 * Productverhalen voor de timmerman-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de timmerbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je timmerbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een timmerman zoekt voor verbouwing of maatwerk, en laat met een strakke site je vakwerk zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je timmer- en maatwerkprojecten in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een timmerman zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je timmerwerk online',
      'intro' => 'Timmerwerk verkoopt op vakmanschap. Je site laat je verbouwingen, maatwerk en afwerking zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'HoutHelder',
      'heroTitle' => 'Van verbouwing tot maatwerk, vakkundig getimmerd',
      'urlLabel' => 'jouw-timmerbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerde timmerklussen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je timmerbedrijf, naast je werk',
      'sub' => 'Verkoop hout, plaatmateriaal en beslag online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast timmeren ook materiaal leveren? Klanten en collega-timmerlieden bestellen zelf, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'HoutHelder',
      'heroTitle' => 'Bestel hout en plaatmateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-timmerbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-timmerbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je timmerbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-timmerbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je timmerbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je met de zaag te werken, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een timmerbedrijf.',
      'brand' => 'HoutHelder',
