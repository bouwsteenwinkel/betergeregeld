...
return [
    ...
    /*
     * Het woord voor de ONDERNEMING, waar `trade` de PERSOON is.
     *
     * De verkoopteksten spraken de ondernemer aan met "je :trade": "Klaar om te
     * groeien met je rijschool in Middelburg?" Dat werkt zolang :trade een zaak
     * is. Bij 55 van de 204 branches is het een mens, en dan staat er "je
     * acupuncturist" of "je advocaat" -- wat niet alleen krom is, maar de
     * pagina ook van toon laat wisselen: van "wij bouwen jou een site" naar
     * iets dat leest als een consumentengids.
     *
     * Dat is precies wat Search Console liet zien: jouw-acupuncturist-website.nl
     * werd gevonden op "acupunctuur zeeland" en "acupunctuur nieuw vennep" --
     * door patienten dus, niet door acupuncturisten. Met 195 branches in de
     * wachtrij, waarvan ruim een kwart een beroep is, loopt dat mee naar de
     * hele uitbreiding.
     *
     * Waar hier niets staat, valt :zaak terug op :trade -- precies goed voor de
     * 149 branches die al een zaak zijn (rijschool, bakkerij, apotheek).
     */
    'zaakwoord' => [
        // zorg en behandeling
        'acupuncturist'  => 'praktijk',   'dierenarts'     => 'praktijk',
        'dietist'        => 'praktijk',   'ergotherapeut'  => 'praktijk',
        'fysiotherapeut' => 'praktijk',   'huidtherapeut'  => 'praktijk',
        'logopedist'     => 'praktijk',   'mondhygienist'  => 'praktijk',
        'optometrist'    => 'praktijk',   'orthodontist'   => 'praktijk',
        'osteopaat'      => 'praktijk',   'podotherapeut'  => 'praktijk',
        'psycholoog'     => 'praktijk',   'tandarts'       => 'praktijk',
        'verloskundige'  => 'praktijk',

        // kantoor en advies
        'aankoopmakelaar'    => 'kantoor', 'advocaat'          => 'kantoor',
        'bedrijfsmakelaar'   => 'kantoor', 'belastingadviseur' => 'kantoor',
        'energieadviseur'    => 'kantoor', 'hypotheekadviseur' => 'kantoor',
        'juridisch-adviseur' => 'kantoor', 'makelaar'          => 'kantoor',
        'notaris'            => 'kantoor', 'taxateur'          => 'kantoor',
        'verhuurmakelaar'    => 'kantoor',

        // eenmanszaak / dienstverlening
        'businesscoach'     => 'praktijk', 'consultant'        => 'bureau',
        'loopbaancoach'     => 'praktijk', 'personal-trainer'  => 'praktijk',
        'trainer'           => 'praktijk', 'vertaler'          => 'bureau',
        'virtual-assistant' => 'bedrijf',

        // studio en creatief
        'fotograaf'  => 'studio', 'videograaf' => 'studio',
        'visagist'   => 'studio', 'barbier'    => 'zaak',
    ...
    'variants' => [
        ...
        'meta_description' => [
            ...
            'Meer klanten voor je :zaak in :city? Wij regelen je online groei van begin tot eind. Vooraf een gratis voorbeeld, en je weet je prijs voordat je iets beslist.',
            ...
            'Een :service voor je :zaak in :city, gemaakt om gevonden te worden en klanten te laten bellen. Vaste prijs vooraf, één aanspreekpunt, en eerst een gratis voorbeeld.',
        ...
        'hero_lead' => [
            ...
            'Iemand in :city zoekt een :niche, vindt jouw :zaak bovenaan, ziet in één oogopslag wat je doet en neemt contact op. Zo hoort het te werken. Wij bouwen de :service die dat mogelijk maakt, en je ziet vooraf gratis hoe die eruit gaat zien.',
            'Je vak beheers je. De online kant erbij doen kost avonden die je liever anders besteedt. Laat dat aan ons: wij zorgen dat je :zaak gevonden wordt in :city en dat aanvragen rechtstreeks bij je binnenkomen, zonder dat je ergens aan vast zit om te beginnen.',
        ...
        'intro' => [
            ...
            'De meeste mensen in :city zoeken pas een :niche op het moment dat het nodig is, en dan willen ze snel iemand vinden die betrouwbaar overkomt. Sta je daar niet tussen, dan bellen ze de volgende. Een goede :service zorgt dat jouw :zaak wél in dat rijtje staat.',
        ...
        'trust' => [
            ...
            'Het vertrouwen van ondernemers in :city en heel Nederland is waar we het van moeten hebben. Daarom leveren we echt maatwerk, denken we mee over wat jouw :zaak nodig heeft, en zijn we bereikbaar als er iets is. Je begint klein en breidt uit wanneer het jou uitkomt.',
            ...
            'Eén vast aanspreekpunt in Nederland, dat opneemt als je belt en weet waar jouw :zaak in :city over gaat. Geen wisselende contactpersonen en geen ticketsysteem waar je antwoord in verdwijnt. Dat is het soort samenwerking waar we op mikken.',
        ],

        'cta_title' => [
            'Klaar om te groeien met je :zaak in :city?',
            'Meer aanvragen in :city? Begin hier.',
            'Jouw :zaak online in :city.',
            'Zet de eerste stap in :city.',
            'Zo ziet jouw :zaak er online uit.',
        ...
        'cta' => [
            ...
            'Benieuwd hoe jouw :zaak er online uit zou zien in :city? Vraag een gratis voorbeeld aan, wij zetten het voor je klaar.',
            ...
            'Typ je bedrijfsnaam in en je ziet binnen een paar minuten een voorbeeld van jouw :zaak in :city. Gratis, en je hoeft er niets voor af te spreken.',
            ...
            'Wil je weten wat dit voor jouw :zaak in :city zou betekenen? Vraag het voorbeeld aan, dan bellen we je met een eerlijk verhaal over wat het je oplevert.',
        ],
        ...
        [
            ...
            [
                ...
                'a' => 'Dat kun je zelf, en anders doen wij het. Kleine aanpassingen zoals openingstijden of een nieuwe foto zijn zo gedaan. Groeit je :zaak en wil je een webshop of een klantenportaal erbij, dan bouwen we dat op dezelfde site verder uit.',
            ],
            [
