...
/**
 * Productverhalen voor de isolatiebedrijf-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de isolatiebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je isolatiebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand wil isoleren en energie wil besparen, en laat met een strakke site je oplossingen en subsidievoordeel zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je besparing en subsidievoordeel meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een isolatiebedrijf zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je isolatiewerk online',
      'intro' => 'Isoleren draait om besparing. Je site laat je oplossingen, de besparing en het subsidievoordeel zien, zodat een klant de stap zet en voor jou kiest.',
      'brand' => 'IsoPro',
      'heroTitle' => 'Isoleren en besparen? Snel en netjes geregeld',
      'urlLabel' => 'jouw-isolatiebedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerde isolatieklussen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je isolatiebedrijf, naast je werk',
      'sub' => 'Verkoop isolatiemateriaal en toebehoren online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast isoleren ook materiaal leveren? Klanten bestellen zelf isolatieplaten en folie, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'IsoPro',
      'heroTitle' => 'Bestel isolatiemateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-isolatiebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-isolatiebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je isolatiebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-isolatiebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je isolatiebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je te isoleren op een zolder, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een isolatiebedrijf.',
      'brand' => 'IsoPro',
