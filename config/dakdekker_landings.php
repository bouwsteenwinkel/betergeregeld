...
/**
 * Productverhalen voor de dakdekker-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de dakdekkersbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je dakdekkersbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een lekkend of nieuw dak zoekt in jouw regio, en laat met een strakke site je vakwerk en spoedservice zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je spoedreparaties en dakwerk meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een dakdekker zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je dakwerk en je spoedservice online',
      'intro' => 'Een lekkend dak is spoed. Je site laat je bereikbaarheid, je vakwerk en afgeronde daken zien, zodat een klant met een gerust hart meteen jóu belt.',
      'brand' => 'DakVast',
      'heroTitle' => 'Lekkend dak of nieuwe dakbedekking? Snel en vakkundig geregeld',
      'urlLabel' => 'jouw-dakdekkersbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerde dakklussen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je dakdekkersbedrijf, naast je werk',
      'sub' => 'Verkoop dakmateriaal en gereedschap online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast dakwerk ook materiaal leveren? Klanten en collega-dakdekkers bestellen zelf, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'DakVast',
      'heroTitle' => 'Bestel dakmateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-dakdekkersbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-dakdekkersbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je dakdekkersbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-dakdekkersbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je dakdekkersbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op een dak, dan kun je niet opnemen. De assistent vangt de aanvraag op en noteert de spoed.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een dakdekkersbedrijf.',
      'brand' => 'DakVast',
