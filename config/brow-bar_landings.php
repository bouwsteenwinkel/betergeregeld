...
/**
 * Verkooplaag voor de brow-bar-triggersite (auto-gegenereerd, mode=zorg).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de browbar. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je browbar die klanten oplevert',
      'sub' => 'Word gevonden als iemand een brow bar zoekt in de buurt, en laat met een strakke site zien dat mensen bij jou in goede handen zijn.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een brow bar zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je browbar, naast je werk',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je browbar',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je browbar die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een browbar.',
      'brand' => 'BrowStudio',
