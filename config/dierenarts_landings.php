...
/**
 * Productverhalen voor de dierenarts-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de dierenartspraktijk. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je dierenartspraktijk die klanten oplevert',
      'sub' => 'Word gevonden als iemand een dierenarts zoekt in jouw regio, en laat met een strakke site zien dat baasje en dier bij jou in goede handen zijn.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je spreekuren en spoedservice meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een dierenarts zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je praktijk en je afspraken online',
      'intro' => 'Een dierenarts kies je op vertrouwen. Je site laat je team, je spreekuren en online afspraken zien, zodat een baasje met een gerust hart voor jou kiest.',
      'brand' => 'VetPraktijk',
      'heroTitle' => 'Je huisdier in goede handen: plan eenvoudig een afspraak',
      'urlLabel' => 'jouw-dierenartspraktijk.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Een kijkje in de praktijk',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je dierenartspraktijk, naast je werk',
      'sub' => 'Verkoop voer, verzorgingsproducten en preventiemiddelen online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast behandelen ook producten leveren? Baasjes bestellen zelf voer en verzorging, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'VetPraktijk',
      'heroTitle' => 'Bestel voer en verzorging online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-dierenartspraktijk.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-dierenartspraktijk.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je dierenartspraktijk',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-dierenartspraktijk.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je dierenartspraktijk die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Zit je in de spreekkamer, dan gaat het bellende baasje vaak naar een andere praktijk. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een dierenartspraktijk.',
      'brand' => 'VetPraktijk',
