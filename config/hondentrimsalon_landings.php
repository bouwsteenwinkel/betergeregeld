...
/**
 * Productverhalen voor de hondentrimsalon-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de trimsalon. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je trimsalon die klanten oplevert',
      'sub' => 'Word gevonden als iemand een trimsalon zoekt in de buurt, en laat met een strakke site je vakwerk en zachte aanpak zien.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een hondentrimsalon zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je trimwerk en je afspraken online',
      'intro' => 'Een trimsalon kies je op vertrouwen en resultaat. Je site laat je voor-en-na, je aanpak en online afspraken zien, zodat een baasje met een gerust hart voor jou kiest.',
      'brand' => 'TrimPro',
      'heroTitle' => 'Hond laten trimmen? Plan eenvoudig een afspraak',
      'urlLabel' => 'jouw-trimsalon.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Voor en na het trimmen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je trimsalon, naast je werk',
      'sub' => 'Verkoop verzorgingsproducten en accessoires online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast trimmen ook producten leveren? Baasjes bestellen zelf shampoo en verzorging, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'TrimPro',
      'heroTitle' => 'Bestel verzorgingsproducten online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-trimsalon.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-trimsalon.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je trimsalon',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-trimsalon.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je trimsalon die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je een hond aan het trimmen, dan kun je niet opnemen. De assistent vangt de afspraakaanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een trimsalon.',
      'brand' => 'TrimPro',
