...
/**
 * Productverhalen voor de warmtepomp-installateur-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de warmtepompbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je warmtepompbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een warmtepomp wil laten plaatsen, en laat met een strakke site de besparing en je installaties zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je besparing, subsidie en installaties meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een warmtepomp installateur zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je installaties en je advies online',
      'intro' => 'Een warmtepomp draait om besparing en vertrouwen. Je site laat je installaties, de besparing en het subsidievoordeel zien, zodat een klant de stap zet en voor jou kiest.',
      'brand' => 'WarmteWerk',
      'heroTitle' => 'Van het gas af met een warmtepomp? Snel en netjes geregeld',
      'urlLabel' => 'jouw-warmtepompbedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je warmtepompbedrijf, naast je werk',
      'sub' => 'Verkoop warmtepompen, buffervaten en onderdelen online, met installatie bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast installeren ook onderdelen leveren? Klanten bestellen zelf onderdelen en accessoires, betalen met iDEAL of op rekening en boeken installatie bij.',
      'brand' => 'WarmteWerk',
      'heroTitle' => 'Bestel warmtepomp-onderdelen online',
      'urlLabel' => 'shop.jouw-warmtepompbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-warmtepompbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je warmtepompbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-warmtepompbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je warmtepompbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je een installatie aan het aansluiten, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een warmtepompbedrijf.',
      'brand' => 'WarmteWerk',
