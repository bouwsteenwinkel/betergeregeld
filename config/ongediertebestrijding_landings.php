...
/**
 * Verkooplaag voor de ongediertebestrijding-triggersite (auto-gegenereerd, mode=bouw).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de ongediertebestrijder. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je ongediertebestrijder die klussen oplevert',
      'sub' => 'Word gevonden als iemand een ongediertebestrijding zoekt in jouw regio, en laat met een strakke site je vakwerk en service zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je diensten en tarieven meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een ongediertebestrijding zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Vakwerk gun je een betrouwbare partij. Je site laat je werk, je service en je bereikbaarheid zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'PlaagVrij',
      'heroTitle' => 'Vakwerk nodig? Snel en netjes geregeld',
      'urlLabel' => 'jouw-ongediertebestrijder.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerd werk',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je ongediertebestrijder, naast je werk',
      'sub' => 'Verkoop producten, onderdelen of materialen online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast je werk ook producten leveren? Klanten bestellen zelf, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'PlaagVrij',
      'heroTitle' => 'Bestel online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-ongediertebestrijder.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-ongediertebestrijder.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je ongediertebestrijder',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-ongediertebestrijder.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je ongediertebestrijder die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je aan het werk, dan gaat de klus vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een ongediertebestrijder.',
      'brand' => 'PlaagVrij',
