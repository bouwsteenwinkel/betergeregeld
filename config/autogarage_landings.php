...
/**
 * Productverhalen voor de autogarage-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de garagebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je garagebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand onderhoud, APK of reparatie zoekt in jouw regio, en laat met een strakke site je service en tarieven zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je APK, onderhoud en tarieven meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een autogarage zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Onderhoud draait om vertrouwen en gemak. Je site laat je service, je tarieven en online afspraken zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'GarageVinden',
      'heroTitle' => 'APK, onderhoud of reparatie? Plan je afspraak online',
      'urlLabel' => 'jouw-garagebedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je garagebedrijf, naast je werk',
      'sub' => 'Verkoop onderdelen, banden en accessoires online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast repareren ook onderdelen leveren? Klanten bestellen zelf onderdelen en banden, betalen met iDEAL of op rekening en boeken montage bij.',
      'brand' => 'GarageVinden',
      'heroTitle' => 'Bestel onderdelen en banden online',
      'urlLabel' => 'shop.jouw-garagebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-garagebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je garagebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-garagebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je garagebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een garagebedrijf.',
      'brand' => 'GarageVinden',
