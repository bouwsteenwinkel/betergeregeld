...
/**
 * Productverhalen voor de elektricien-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de elektrabedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je elektrabedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een elektricien zoekt voor een storing, groepenkast of nieuwe installatie, en laat met een strakke site je service zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je spoedservice en installaties meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een elektricien zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je vakwerk en je spoedservice online',
      'intro' => 'Elektra draait om veiligheid en vertrouwen. Je site laat je erkenning, je installaties en je bereikbaarheid zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'Voltwerk',
      'heroTitle' => 'Storing, groepenkast of nieuwe installatie? Snel en veilig geregeld',
      'urlLabel' => 'jouw-elektrabedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je elektrabedrijf, naast je werk',
      'sub' => 'Verkoop schakelmateriaal, verlichting en laadpalen online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast installeren ook materiaal leveren? Klanten bestellen zelf verlichting en schakelmateriaal, betalen met iDEAL of op rekening en boeken montage bij.',
      'brand' => 'Voltwerk',
      'heroTitle' => 'Bestel elektramateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-elektrabedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-elektrabedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je elektrabedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-elektrabedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je elektrabedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je in een meterkast te werken, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een elektrabedrijf.',
      'brand' => 'Voltwerk',
