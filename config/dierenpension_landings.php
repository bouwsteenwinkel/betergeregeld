...
/**
 * Productverhalen voor de dierenpension-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de dierenpension. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je dierenpension die klanten oplevert',
      'sub' => 'Word gevonden als iemand opvang zoekt voor hond of kat, en laat met een strakke site zien dat hun huisdier bij jou een fijne tijd heeft.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je verblijf, prijzen en beschikbaarheid meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een dierenpension zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je pension en je boekingen online',
      'intro' => 'Opvang kies je op vertrouwen. Je site laat je verblijven, je verzorging en online boeken zien, zodat een baasje met een gerust hart voor jou kiest.',
      'brand' => 'PoteThuis',
      'heroTitle' => 'Op vakantie? Je huisdier logeert veilig en verzorgd',
      'urlLabel' => 'jouw-dierenpension.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Een kijkje in het pension',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je dierenpension, naast je werk',
      'sub' => 'Verkoop verzorgingsproducten en extra services online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast opvang ook producten en extra\'s aanbieden? Klanten boeken en bestellen zelf, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'PoteThuis',
      'heroTitle' => 'Boek verblijf en extra\'s online',
      'urlLabel' => 'shop.jouw-dierenpension.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Vaak geboekt',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-dierenpension.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je dierenpension',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-dierenpension.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je dierenpension die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je met de dieren bezig, dan gaat de bellende klant vaak naar een ander pension. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een dierenpension.',
      'brand' => 'PoteThuis',
