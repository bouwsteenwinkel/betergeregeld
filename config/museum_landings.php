...
/**
 * Verkooplaag voor de museum-triggersite (auto-gegenereerd, mode=horeca).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de museum. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je museum die gasten oplevert',
      'sub' => 'Word gevonden als iemand een museum zoekt in de buurt, en laat met een strakke site je kaart, sfeer en reserveren zien.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een museum zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Online bestellen en reserveren voor je museum',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je museum',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je museum die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Een gemiste telefoon is een lege tafel. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een museum.',
      'brand' => 'MuseumFlow',
