...
/**
 * Productverhalen voor de motorzaak-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de motorbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je motorbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand onderhoud, banden of een occasion-motor zoekt, en laat met een strakke site je aanbod en service zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je onderhoud, banden en aanbod meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een motor onderhoud zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Motorrijders kiezen op vertrouwen. Je site laat je onderhoud, je aanbod en online afspraken zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'MotorMakers',
      'heroTitle' => 'Onderhoud, banden of een nieuwe motor? Snel geregeld',
      'urlLabel' => 'jouw-motorbedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je motorbedrijf, naast je werk',
      'sub' => 'Verkoop onderdelen, accessoires en motorkleding online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast sleutelen ook producten leveren? Klanten bestellen zelf onderdelen en kleding, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'MotorMakers',
      'heroTitle' => 'Bestel onderdelen en kleding online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-motorbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-motorbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je motorbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-motorbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je motorbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je aan een motor aan het sleutelen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een motorbedrijf.',
      'brand' => 'MotorMakers',
