...
/**
 * Productverhalen voor de loonbedrijf-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de loonbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je loonbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als een boer of grondeigenaar loonwerk zoekt in de regio, en laat met een strakke site je machines en diensten zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je machines, diensten en werkgebied meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een loonbedrijf zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je machines en je opdrachten online',
      'intro' => 'Loonwerk gun je een betrouwbare partij. Je site laat je machinepark, je diensten en je werkgebied zien, zodat een opdrachtgever met een gerust hart voor jou kiest.',
      'brand' => 'AkkerKracht',
      'heroTitle' => 'Maaien, oogsten of grondwerk? Vakkundig en op tijd geregeld',
      'urlLabel' => 'jouw-loonbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerd loonwerk',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je loonbedrijf, naast je werk',
      'sub' => 'Verhuur van machines en verkoop van onderdelen online te boeken, met levering op locatie.',
    ...
    array (
      ...
      'intro' => 'Naast loonwerk ook machines verhuren of onderdelen leveren? Klanten boeken en bestellen zelf, betalen met iDEAL of op rekening en kiezen levering of afhalen.',
      'brand' => 'AkkerKracht',
      'heroTitle' => 'Boek machines of bestel onderdelen online',
      'urlLabel' => 'shop.jouw-loonbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-loonbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je loonbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-loonbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je loonbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Zit je op de trekker, dan gaat de opdracht vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een loonbedrijf.',
      'brand' => 'AkkerKracht',
