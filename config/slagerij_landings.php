...
/**
 * Verkooplaag voor de slagerij-triggersite (auto-gegenereerd, mode=retail).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de slagerij. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je slagerij die klanten oplevert',
      'sub' => 'Word gevonden als iemand een slagerij zoekt in jouw regio, en laat met een strakke site je assortiment en sfeer zien.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een slagerij zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je slagerij',
    ...
    array (
      ...
      'urlLabel' => 'shop.jouw-slagerij.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-slagerij.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je slagerij',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je slagerij die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Een vraag die blijft liggen is een gemiste verkoop. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen over producten en levertijden, dag en nacht. Bekijk hoe dat werkt op een slagerij.',
      'brand' => 'VleesVak',
