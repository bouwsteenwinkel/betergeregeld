...
/**
 * Productverhalen voor de interieurbouwer-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de interieurbouwbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je interieurbouwbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand maatwerkmeubels of een inbouwkast zoekt, en laat met een strakke site je mooiste projecten zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je maatwerkprojecten in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een interieurbouwer zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je maatwerk online',
      'intro' => 'Maatwerk verkoopt op beeld. Je site laat je gemaakte kasten, keukens en meubels zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'MaatMeester',
      'heroTitle' => 'Van ontwerp tot geplaatst maatwerk, in één hand',
      'urlLabel' => 'jouw-interieurbouwbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent gemaakte projecten',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je interieurbouwbedrijf, naast je werk',
      'sub' => 'Verkoop standaard maatwerk-opties, beslag en materialen online, met plaatsing bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast maken ook materialen en beslag leveren? Klanten bestellen zelf, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'MaatMeester',
      'heroTitle' => 'Bestel materialen en beslag online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-interieurbouwbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-interieurbouwbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je interieurbouwbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-interieurbouwbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je interieurbouwbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je in de werkplaats te zagen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een interieurbouwbedrijf.',
      'brand' => 'MaatMeester',
