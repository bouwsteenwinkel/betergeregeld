...
/**
 * Verkooplaag voor de permanente-make-up-triggersite (auto-gegenereerd, mode=zorg).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de pmu-studio. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je pmu-studio die klanten oplevert',
      'sub' => 'Word gevonden als iemand een permanente make-up zoekt in de buurt, en laat met een strakke site zien dat mensen bij jou in goede handen zijn.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een permanente make-up zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je pmu-studio, naast je werk',
    ...
    array (
      ...
      'urlLabel' => 'shop.jouw-pmu-studio.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-pmu-studio.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je pmu-studio',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-pmu-studio.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je pmu-studio die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een pmu-studio.',
      'brand' => 'PermaLijn',
