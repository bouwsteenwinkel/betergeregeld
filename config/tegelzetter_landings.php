...
/**
 * Productverhalen voor de tegelzetter-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de tegelzettersbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je tegelzettersbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand wand- of vloertegels wil laten zetten, en laat met een strakke site je strakke tegelwerk zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je strakke tegelwerk in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een tegelzetter zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je tegelwerk online',
      'intro' => 'Tegelwerk verkoopt op precisie. Je site laat je afgeronde badkamers, vloeren en wanden zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'TegelVak',
      'heroTitle' => 'Strak tegelwerk, netjes gevoegd en waterdicht',
      'urlLabel' => 'jouw-tegelzettersbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerd tegelwerk',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je tegelzettersbedrijf, naast je werk',
      'sub' => 'Verkoop tegels, lijm en voegmateriaal online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast tegelen ook tegels leveren? Klanten bestellen zelf tegels en voegmateriaal, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'TegelVak',
      'heroTitle' => 'Bestel tegels online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-tegelzettersbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-tegelzettersbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je tegelzettersbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-tegelzettersbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je tegelzettersbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Zit je op je knieën te tegelen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een tegelzettersbedrijf.',
      'brand' => 'TegelVak',
