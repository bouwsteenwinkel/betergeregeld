...
/**
 * Productverhalen voor de bandenservice-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de bandenservicebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je bandenservicebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand banden zoekt of wil wisselen, en laat met een strakke site je aanbod, opslag en tarieven zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je bandenaanbod, opslag en tarieven meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een bandenservice zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je aanbod en je afspraken online',
      'intro' => 'Banden koop en wissel je op gemak. Je site laat je aanbod, je bandenopslag en online afspraken zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'BandenBaas',
      'heroTitle' => 'Banden wisselen of nieuwe set? Plan je afspraak online',
      'urlLabel' => 'jouw-bandenservicebedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent gemonteerd',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je bandenservicebedrijf, naast je werk',
      'sub' => 'Verkoop banden, velgen en toebehoren online, met montage en balanceren bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast monteren ook banden leveren? Klanten kiezen zelf hun maat, betalen met iDEAL of op rekening en boeken montage bij.',
      'brand' => 'BandenBaas',
      'heroTitle' => 'Bestel banden online en boek montage',
      'urlLabel' => 'shop.jouw-bandenservicebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-bandenservicebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je bandenservicebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-bandenservicebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je bandenservicebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je banden aan het wisselen, dan gaat de klant vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een bandenservicebedrijf.',
      'brand' => 'BandenBaas',
