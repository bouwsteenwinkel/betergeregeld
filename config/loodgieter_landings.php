...
return [
    ...
    'ai' => [
        'hero' => [
            ...
            'sub'     => 'De assistent neemt telefoon en chat aan, vraagt door naar de storing en de spoed en zet de melding voor je klaar. Dag en nacht, in gewoon Nederlands.',
        ...
        'zkhw' => [
            ...
            'intro'        => 'Bel je een keer niet op tijd terug, dan is de spoedklus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een loodgietersbedrijf.',
            'brand'        => 'Waterwerk',
