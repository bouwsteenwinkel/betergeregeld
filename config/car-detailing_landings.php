...
/**
 * Productverhalen voor de car-detailing-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de detailingbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je detailingbedrijf die klanten oplevert',
      'sub' => 'Word gevonden als iemand zijn auto professioneel wil laten poetsen of beschermen, en laat met een strakke site je voor-en-na resultaten zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je pakketten en voor-en-na resultaten meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een car detailing zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je vakwerk en je afspraken online',
      'intro' => 'Detailing verkoopt op glans en detail. Je site laat je voor-en-na, je pakketten en online afspraken zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'GlansGarage',
      'heroTitle' => 'Je auto weer als nieuw: plan een detailing-afspraak online',
      'urlLabel' => 'jouw-detailingbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Voor en na de behandeling',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je detailingbedrijf, naast je werk',
      'sub' => 'Verkoop poets- en beschermingsproducten online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast detailen ook producten leveren? Klanten bestellen zelf polish en coating, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'GlansGarage',
      'heroTitle' => 'Bestel detailing-producten online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-detailingbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-detailingbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je detailingbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-detailingbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je detailingbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je een auto aan het poetsen, dan gaat de bellende klant vaak naar een ander. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een detailingbedrijf.',
      'brand' => 'GlansGarage',
