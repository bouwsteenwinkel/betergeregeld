...
/**
 * Productverhalen voor de imkerij-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de imkerij. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je imkerij die klanten oplevert',
      'sub' => 'Word gevonden als iemand lokale honing of bijenproducten zoekt, en laat met een strakke site je verhaal en assortiment zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je honingsoorten en herkomst meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een honing kopen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je honing 24/7 online',
      'intro' => 'Lokale honing koop je op verhaal en vertrouwen. Je site laat je producten, je bijen en online bestellen zien, zodat een klant makkelijk en vaker bij je koopt.',
      'brand' => 'RaatWerk',
      'heroTitle' => 'Pure lokale honing? Bekijk het assortiment en bestel online',
      'urlLabel' => 'jouw-imkerij.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Uit de imkerij',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je imkerij',
      'sub' => 'Verkoop honing, bijenwas en cadeaupakketten online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Je imkerij is 24/7 open. Klanten bestellen zelf honing en bijenproducten, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'RaatWerk',
      'heroTitle' => 'Bestel honing online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-imkerij.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je imkerij',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je imkerij die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je bij de bijenkasten bezig, dan blijft een vraag liggen. De assistent vangt dat op en helpt de klant meteen.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Een vraag die blijft liggen is een gemiste verkoop. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen over producten en levertijden, dag en nacht. Bekijk hoe dat werkt op een imkerij.',
      'brand' => 'RaatWerk',
