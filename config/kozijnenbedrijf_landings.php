...
/**
 * Productverhalen voor de kozijnenbedrijf-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de kozijnenbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je kozijnenbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand kozijnen wil vervangen, en laat met een strakke site je uitvoeringen en het comfortvoordeel zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je uitvoeringen en isolatievoordeel meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een kunststof kozijnen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je kozijnen online',
      'intro' => 'Kozijnen kies je op maat en op uitstraling. Je site laat je uitvoeringen, montage en het comfortvoordeel zien, zodat een klant precies vindt wat past en voor jou kiest.',
      'brand' => 'Kozijnkracht',
      'heroTitle' => 'Nieuwe kozijnen: meer comfort en minder energie',
      'urlLabel' => 'jouw-kozijnenbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent geplaatste kozijnen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je kozijnenbedrijf, naast je werk',
      'sub' => 'Verkoop kozijnen, ramen en beslag online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast plaatsen ook onderdelen leveren? Klanten bestellen zelf beslag en ramen, betalen met iDEAL of op rekening en boeken montage bij.',
      'brand' => 'Kozijnkracht',
      'heroTitle' => 'Stel je kozijnen samen en boek montage',
      'urlLabel' => 'shop.jouw-kozijnenbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-kozijnenbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je kozijnenbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-kozijnenbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je kozijnenbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je kozijnen te stellen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een kozijnenbedrijf.',
      'brand' => 'Kozijnkracht',
