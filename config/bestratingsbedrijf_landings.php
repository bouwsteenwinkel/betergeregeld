...
/**
 * Productverhalen voor de bestratingsbedrijf-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de bestratingsbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je bestratingsbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een oprit, terras of tuin wil laten bestraten, en laat met een strakke site je mooiste projecten zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je mooiste opritten en terrassen in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een bestrating zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je bestratingswerk online',
      'intro' => 'Bestrating is zichtbaar vakwerk. Je site laat je afgeronde opritten, terrassen en tuinpaden zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'SteenVast',
      'heroTitle' => 'Van zand tot strak gelegd terras, netjes afgewerkt',
      'urlLabel' => 'jouw-bestratingsbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent bestrate projecten',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je bestratingsbedrijf, naast je werk',
      'sub' => 'Verkoop bestratingsmateriaal en sierbestrating online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast leggen ook stenen leveren? Klanten bestellen zelf sierbestrating en split, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'SteenVast',
      'heroTitle' => 'Bestel sierbestrating online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-bestratingsbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-bestratingsbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je bestratingsbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-bestratingsbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je bestratingsbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op je knieën te straten, dan gaat de klus vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een bestratingsbedrijf.',
      'brand' => 'SteenVast',
