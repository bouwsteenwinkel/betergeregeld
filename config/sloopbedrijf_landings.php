...
/**
 * Productverhalen voor de sloopbedrijf-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de sloopbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je sloopbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een sloop- of stripklus heeft, en laat met een strakke site zien dat je snel, netjes en veilig werkt.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je werkwijze en nette oplevering meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een sloopbedrijf zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je sloopwerk online',
      'intro' => 'Sloopwerk draait om snelheid en netheid. Je site laat je projecten, je werkwijze en je nette oplevering zien, zodat een opdrachtgever met een gerust hart voor jou kiest.',
      'brand' => 'SloopKracht',
      'heroTitle' => 'Slopen of strippen? Snel, veilig en netjes opgeleverd',
      'urlLabel' => 'jouw-sloopbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerde sloopprojecten',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je sloopbedrijf, naast je werk',
      'sub' => 'Verhuur van containers en materieel online te boeken, met afvoer inbegrepen.',
    ...
    array (
      ...
      'intro' => 'Naast slopen ook containers verhuren? Klanten boeken zelf een container, betalen met iDEAL of op rekening en kiezen een plaatsingsdatum.',
      'brand' => 'SloopKracht',
      'heroTitle' => 'Boek een afvalcontainer online, bezorgd op locatie',
      'urlLabel' => 'shop.jouw-sloopbedrijf.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Veel geboekt',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-sloopbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je sloopbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-sloopbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je sloopbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je met een sloophamer te werken, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een sloopbedrijf.',
      'brand' => 'SloopKracht',
