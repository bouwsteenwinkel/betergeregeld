...
/**
 * Productverhalen voor de traprenovatie-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de traprenovatiebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je traprenovatiebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een oude trap wil laten renoveren, en laat met een strakke site het voor-en-na resultaat zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je voor-en-na resultaten in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een traprenovatie zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je traprenovaties online',
      'intro' => 'Traprenovatie verkoopt op voor-en-na. Je site laat je vernieuwde trappen en tevreden klanten zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'TrapFris',
      'heroTitle' => 'In één dag een nieuwe trap, zonder sloop',
      'urlLabel' => 'jouw-traprenovatiebedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent gerenoveerde trappen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je traprenovatiebedrijf, naast je werk',
      'sub' => 'Verkoop traptreden, hoeslijsten en anti-slip online, met plaatsing bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast renoveren ook onderdelen leveren? Klanten kiezen zelf hun uitvoering, betalen aanbetaling met iDEAL en boeken plaatsing bij.',
      'brand' => 'TrapFris',
      'heroTitle' => 'Stel je trap samen en boek plaatsing',
      'urlLabel' => 'shop.jouw-traprenovatiebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-traprenovatiebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je traprenovatiebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-traprenovatiebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je traprenovatiebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je een trap te bekleden, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een traprenovatiebedrijf.',
      'brand' => 'TrapFris',
