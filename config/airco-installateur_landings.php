...
/**
 * Productverhalen voor de airco-installateur-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de aircobedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je aircobedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een airco wil laten plaatsen of onderhouden, en laat met een strakke site je installaties en service zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je installaties, onderhoud en tarieven meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een airco installateur zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je installaties en je service online',
      'intro' => 'Een airco kies je op comfort en vertrouwen. Je site laat je installaties, het comfort en je onderhoudsservice zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'KoelKracht',
      'heroTitle' => 'Airco plaatsen of onderhouden? Snel en netjes geregeld',
      'urlLabel' => 'jouw-aircobedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je aircobedrijf, naast je werk',
      'sub' => 'Verkoop airco-units, onderdelen en filters online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast installeren ook units leveren? Klanten bestellen zelf airco\'s en filters, betalen met iDEAL of op rekening en boeken montage bij.',
      'brand' => 'KoelKracht',
      'heroTitle' => 'Bestel airco-units online en boek montage',
      'urlLabel' => 'shop.jouw-aircobedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-aircobedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je aircobedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-aircobedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je aircobedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op een ladder een unit te hangen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een aircobedrijf.',
      'brand' => 'KoelKracht',
