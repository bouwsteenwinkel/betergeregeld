...
/**
 * Verkooplaag voor de beveiligingsbedrijf-triggersite (auto-gegenereerd, mode=dienst).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de beveiligingsbedrijf. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je beveiligingsbedrijf die klanten oplevert',
      'sub' => 'Word gevonden als iemand een beveiligingsbedrijf zoekt in jouw regio, en laat met een strakke site je expertise en aanpak zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je expertise en werkwijze meteen duidelijk',
        2 => 'Aanvragen rechtstreeks in je mailbox',
      ),
    ),
    'pains' => 
    array (
      ...
      array (
        ...
        'text' => 'Wie een beveiligingsbedrijf zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je expertise en je service online',
      'intro' => 'Een adviseur kies je op vertrouwen. Je site laat je expertise, je aanpak en tevreden klanten zien, zodat een opdrachtgever met een gerust hart voor jou kiest.',
      'brand' => 'SafeGuard',
      'heroTitle' => 'Goed advies nodig? Kennismaken kan zo gepland zijn',
      'urlLabel' => 'jouw-beveiligingsbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Waar we klanten mee helpen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Bied je diensten online aan met je beveiligingsbedrijf',
      'sub' => 'Bied je diensten, pakketten en cadeaubonnen online aan, direct af te rekenen.',
    ...
    array (
      ...
      'intro' => 'Naast maatwerk ook standaard diensten online aanbieden? Klanten boeken zelf een pakket of gesprek, betalen met iDEAL en zijn meteen geholpen.',
      'brand' => 'SafeGuard',
      'heroTitle' => 'Boek een dienst of pakket online',
      'urlLabel' => 'shop.jouw-beveiligingsbedrijf.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Veel gekozen',
      'gallery' => 
      array (
        0 => 
        array (
      ...
      array (
        ...
        3 => 
        array (
          'title' => 'Vaste klanten boeken zo opnieuw',
          'text' => 'Een vervolg of nieuw pakket is in een paar klikken geboekt.',
        ),
      ),
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-beveiligingsbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je beveiligingsbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-beveiligingsbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je beveiligingsbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Zit je in een gesprek, dan gaat de aanvraag vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een beveiligingsbedrijf.',
      'brand' => 'SafeGuard',
