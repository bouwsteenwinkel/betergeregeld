...
/**
 * Productverhalen voor de asbestverwijdering-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de asbestbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je asbestbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand met spoed asbest moet laten verwijderen, en laat met een strakke site meteen zien dat je gecertificeerd en betrouwbaar werkt.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je certificering en werkwijze meteen duidelijk',
        2 => 'Offerteaanvragen rechtstreeks in je mailbox',
      ),
    ),
    'pains' => 
    array (
      ...
      array (
        ...
        'text' => 'Wie een asbest verwijderen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je vakwerk en je certificering online',
      'intro' => 'Asbest verwijderen draait om veiligheid en vertrouwen. Je site laat je certificering, je werkwijze en afgeronde saneringen zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'AsbestVrij',
      'heroTitle' => 'Gecertificeerd asbest verwijderen, veilig en volgens de regels',
      'urlLabel' => 'jouw-asbestbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerde saneringen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je asbestbedrijf, naast je werk',
      'sub' => 'Verkoop beschermingsmiddelen en saneringsmateriaal online. Zakelijke klanten bestellen op rekening.',
    ...
    array (
      0 => 
      array (
        'title' => 'Je verdient nu niks naast je uren',
        'text' => 'Klanten kopen elders online, terwijl jij het net zo goed kunt leveren én plaatsen.',
      ),
      1 => 
      array (
      ...
      2 => 
      array (
        'title' => 'Zakelijke klanten kopen elders',
        'text' => 'Met een webshop op rekening bestellen collega\'s en aannemers voortaan bij jou.',
      ),
    ),
    'zkhw' => 
    array (
      ...
      'intro' => 'Naast saneren ook materiaal leveren? Klanten bestellen zelf beschermings- en afvoermateriaal, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'AsbestVrij',
      'heroTitle' => 'Bestel saneringsmateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-asbestbedrijf.nl',
      'navCta' => 'Winkelmand',
      ...
      array (
        ...
        array (
          ...
          'text' => 'Direct afgerekend. Vaste klanten en aannemers kunnen op rekening bestellen.',
        ),
        2 => 
        array (
        ...
        3 => 
        array (
          'title' => 'Montage bij te boeken',
          'text' => 'Klant koopt online en vinkt montage aan. Zo verdien je aan het product én de plaatsing.',
        ),
      ),
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-asbestbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je asbestbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-asbestbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je asbestbedrijf die nooit een aanvraag mist',
      ...
      array (
        ...
        2 => 'Noteert wat er moet gebeuren, waar en wanneer',
      ),
    ),
    'pains' => 
    array (
      ...
      array (
        ...
        'text' => 'Sta je in het pak op locatie, dan kun je niet opnemen. De assistent vangt de aanvraag op en noteert de spoed.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een asbestbedrijf.',
      'brand' => 'AsbestVrij',
      ...
      array (
        ...
        1 => 
        array (
          'title' => 'Noteert de klus',
          'text' => 'Wat, waar en wanneer staat voor je klaar, zodat jij de offerte kunt maken.',
        ),
        2 => 
        array (
