...
/**
 * Verkooplaag voor de crossfit-box-triggersite (auto-gegenereerd, mode=zorg).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de crossfit-box. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je crossfit-box die klanten oplevert',
      'sub' => 'Word gevonden als iemand een crossfit-box zoekt in de buurt, en laat met een strakke site zien dat mensen bij jou in goede handen zijn.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een crossfit-box zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je crossfit-box, naast je werk',
    ...
    array (
      ...
      'urlLabel' => 'shop.jouw-crossfit-box.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-crossfit-box.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je crossfit-box',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-crossfit-box.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je crossfit-box die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een crossfit-box.',
      'brand' => 'BoxPulse',
