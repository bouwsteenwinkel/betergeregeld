...
/**
 * Productverhalen voor de boerderijwinkel-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de boerderijwinkel. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je boerderijwinkel die klanten oplevert',
      'sub' => 'Word gevonden als iemand streekproducten zoekt in jouw regio, en laat met een strakke site je verhaal en je assortiment zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je assortiment, openingstijden en verhaal meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een boerderijwinkel zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je streekproducten 24/7 online',
      'intro' => 'Streekproducten koop je op vertrouwen en verhaal. Je site laat je producten, je herkomst en online bestellen zien, zodat een klant vaker en makkelijker bij je koopt.',
      'brand' => 'HofWaar',
      'heroTitle' => 'Vers van het land: bekijk het assortiment en bestel online',
      'urlLabel' => 'jouw-boerderijwinkel.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Vers uit de winkel',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je boerderijwinkel',
      'sub' => 'Verkoop streekproducten, pakketten en cadeaubonnen online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Je winkel is 24/7 open. Klanten bestellen zelf streekproducten en pakketten, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'HofWaar',
      'heroTitle' => 'Bestel streekproducten online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-boerderijwinkel.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-boerderijwinkel.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je boerderijwinkel',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-boerderijwinkel.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je boerderijwinkel die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je in de winkel of op het land, dan blijft een vraag liggen. De assistent vangt dat op en helpt de klant meteen.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Een vraag die blijft liggen is een gemiste verkoop. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen over producten en levertijden, dag en nacht. Bekijk hoe dat werkt op een boerderijwinkel.',
      'brand' => 'HofWaar',
