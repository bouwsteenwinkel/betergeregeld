...
/**
 * Verkooplaag voor de dierenspeciaalzaak-triggersite (auto-gegenereerd, mode=retail).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de dierenspeciaalzaak. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je dierenspeciaalzaak die klanten oplevert',
      'sub' => 'Word gevonden als iemand een dierenspeciaalzaak zoekt in jouw regio, en laat met een strakke site je assortiment en sfeer zien.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een dierenspeciaalzaak zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'urlLabel' => 'jouw-dierenspeciaalzaak.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je dierenspeciaalzaak',
    ...
    array (
      ...
      'urlLabel' => 'shop.jouw-dierenspeciaalzaak.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-dierenspeciaalzaak.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je dierenspeciaalzaak',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-dierenspeciaalzaak.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je dierenspeciaalzaak die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Een vraag die blijft liggen is een gemiste verkoop. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen over producten en levertijden, dag en nacht. Bekijk hoe dat werkt op een dierenspeciaalzaak.',
      'brand' => 'PootAvenue',
