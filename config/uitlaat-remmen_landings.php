...
/**
 * Productverhalen voor de uitlaat-remmen-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de uitlaat- en remmenbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je uitlaat- en remmenbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een uitlaat of remmen moet laten vervangen, en laat met een strakke site je snelle service en vaste prijzen zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je snelle service en vaste prijzen meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een uitlaat vervangen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je service en je afspraken online',
      'intro' => 'Uitlaat en remmen draaien om veiligheid en snelheid. Je site laat je service, je vaste prijzen en online afspraken zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'RemUit',
      'heroTitle' => 'Uitlaat of remmen versleten? Snel en vakkundig vervangen',
      'urlLabel' => 'jouw-uitlaat-enremmenbedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je uitlaat- en remmenbedrijf, naast je werk',
      'sub' => 'Verkoop uitlaten, remblokken en onderdelen online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast monteren ook onderdelen leveren? Klanten bestellen zelf remblokken en uitlaten, betalen met iDEAL of op rekening en boeken montage bij.',
      'brand' => 'RemUit',
      'heroTitle' => 'Bestel uitlaat- en remonderdelen online',
      'urlLabel' => 'shop.jouw-uitlaat-enremmenbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-uitlaat-enremmenbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je uitlaat- en remmenbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-uitlaat-enremmenbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je uitlaat- en remmenbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je onder een auto, dan gaat de klant vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een uitlaat- en remmenbedrijf.',
      'brand' => 'RemUit',
