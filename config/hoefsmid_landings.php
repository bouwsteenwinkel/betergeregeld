...
/**
 * Productverhalen voor de hoefsmid-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de hoefsmederij. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je hoefsmederij die klanten oplevert',
      'sub' => 'Word gevonden als iemand een hoefsmid zoekt in de buurt, en laat met een strakke site je vakmanschap en werkgebied zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je werkgebied en beschikbaarheid meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een hoefsmid zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Een hoefsmid kies je op vakmanschap en betrouwbaarheid. Je site laat je werk, je werkgebied en online afspraken zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'HoefVak',
      'heroTitle' => 'Bekappen of beslaan? Plan eenvoudig een afspraak',
      'urlLabel' => 'jouw-hoefsmederij.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent vakwerk',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je hoefsmederij, naast je werk',
      'sub' => 'Verkoop hoefverzorging en toebehoren online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast bekappen ook producten leveren? Klanten bestellen zelf hoefverzorging, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'HoefVak',
      'heroTitle' => 'Bestel hoefverzorging online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-hoefsmederij.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-hoefsmederij.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je hoefsmederij',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-hoefsmederij.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je hoefsmederij die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je bij een paard aan het werk, dan kun je niet opnemen. De assistent vangt de afspraakaanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een hoefsmederij.',
      'brand' => 'HoefVak',
