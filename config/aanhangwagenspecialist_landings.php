...
/**
 * Productverhalen voor de aanhangwagenspecialist-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de aanhangwagenbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je aanhangwagenbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een aanhangwagen zoekt, huurt of laat repareren, en laat met een strakke site je aanbod en service zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je aanbod, verhuur en reparatie meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een aanhangwagen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je aanbod en service online',
      'intro' => 'Een aanhanger koop of huur je op vertrouwen. Je site laat je aanbod, verhuur en reparatieservice zien, zodat een klant precies vindt wat past en voor jou kiest.',
      'brand' => 'TrailerHub',
      'heroTitle' => 'Aanhanger kopen, huren of repareren? Snel geregeld',
      'urlLabel' => 'jouw-aanhangwagenbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent geleverd en gerepareerd',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je aanhangwagenbedrijf, naast je werk',
      'sub' => 'Verkoop aanhangwagens, onderdelen en accessoires online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast verkopen ook onderdelen leveren? Klanten bestellen zelf lampen, koppelingen en banden, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'TrailerHub',
      'heroTitle' => 'Bestel aanhangeronderdelen online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-aanhangwagenbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-aanhangwagenbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je aanhangwagenbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-aanhangwagenbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je aanhangwagenbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je in de werkplaats bezig, dan gaat de klant vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een aanhangwagenbedrijf.',
      'brand' => 'TrailerHub',
