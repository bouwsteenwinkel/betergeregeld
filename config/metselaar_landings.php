...
/**
 * Productverhalen voor de metselaar-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de metselbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je metselbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand metsel- of voegwerk zoekt, en laat met een strakke site je strakke muren en gevels zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je gemetselde muren en gevels in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een metselaar zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je metselwerk online',
      'intro' => 'Metselwerk is zichtbaar vakwerk. Je site laat je muren, gevels en voegwerk zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'Voegvast',
      'heroTitle' => 'Van fundering tot strakke gevel, netjes gevoegd',
      'urlLabel' => 'jouw-metselbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerde metselklussen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je metselbedrijf, naast je werk',
      'sub' => 'Verkoop stenen, mortel en gereedschap online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast metselen ook materiaal leveren? Klanten en collega-metselaars bestellen zelf, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'Voegvast',
      'heroTitle' => 'Bestel stenen en mortel online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-metselbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-metselbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je metselbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-metselbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je metselbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op een steiger te metselen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een metselbedrijf.',
      'brand' => 'Voegvast',
