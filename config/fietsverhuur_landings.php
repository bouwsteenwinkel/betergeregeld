...
/**
 * Verkooplaag voor de fietsverhuur-triggersite (auto-gegenereerd, mode=horeca).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de fietsverhuurbedrijf. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je fietsverhuurbedrijf die gasten oplevert',
      'sub' => 'Word gevonden als iemand een fietsverhuur zoekt in de buurt, en laat met een strakke site je kaart, sfeer en reserveren zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je kaart, openingstijden en reserveren meteen duidelijk',
        2 => 'Reserveringen die vanzelf binnenkomen',
      ),
    ),
    'pains' => 
    array (
      ...
      array (
        ...
        'text' => 'Wie een fietsverhuur zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je zaak en je reserveringen online',
      'intro' => 'Gasten kiezen op sfeer en gemak. Je site laat je kaart, je sfeer en online reserveren of bestellen zien, zodat een gast met een goed gevoel voor jou kiest.',
      'brand' => 'Fietsrondje',
      'heroTitle' => 'Reserveer een tafel of bestel online, zo geregeld',
      'urlLabel' => 'jouw-fietsverhuurbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Proef de sfeer',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Online bestellen en reserveren voor je fietsverhuurbedrijf',
      'sub' => 'Laat gasten online bestellen, afhalen of een cadeaubon kopen, direct af te rekenen.',
    ...
    array (
      0 => 
      array (
        'title' => 'Je telefoon staat roodgloeiend',
        'text' => 'Reserveringen en bestellingen via de telefoon kosten je tijd tijdens de drukte.',
      ),
      1 => 
      array (
        'title' => 'Gasten bestellen online bij een ander',
        'text' => 'Zonder online bestellen of reserveren gaat de gast naar wie het wél makkelijk maakt.',
      ),
      2 => 
      array (
        'title' => 'No-shows en misverstanden',
        'text' => 'Online reserveren met bevestiging en herinnering scheelt lege tafels.',
      ),
    ),
    'zkhw' => 
    array (
      ...
      'intro' => 'Naast tafelen ook online bestellen of afhalen? Gasten kiezen zelf van de kaart, betalen met iDEAL en halen op of laten bezorgen.',
      'brand' => 'Fietsrondje',
      'heroTitle' => 'Bestel of haal online af',
      'urlLabel' => 'shop.jouw-fietsverhuurbedrijf.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Populair op de kaart',
      'gallery' => 
      array (
        0 => 
        array (
      ...
      array (
        ...
        3 => 
        array (
          'title' => 'Vaste gasten bestellen zo opnieuw',
          'text' => 'Hun favorieten staan klaar, met een paar klikken besteld.',
        ),
      ),
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-fietsverhuurbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je fietsverhuurbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-fietsverhuurbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je fietsverhuurbedrijf die nooit een aanvraag mist',
      'sub' => 'De assistent neemt telefoon en chat aan, beantwoordt vragen en zet reserveringsvragen klaar om terug te bellen. Dag en nacht, in gewoon Nederlands.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Heb je het druk in de zaak, dan blijft de telefoon liggen. De assistent neemt op en noteert de reserveringsvraag.',
      ),
      1 => 
      array (
      ...
      array (
        ...
        'text' => 'Na de drukte staat elk terugbelverzoek in je overzicht, met waar het over ging.',
      ),
    ),
    'zkhw' => 
    array (
      ...
      'intro' => 'Een gemiste telefoon is een lege tafel. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een fietsverhuurbedrijf.',
      'brand' => 'Fietsrondje',
      ...
      array (
        ...
        1 => 
        array (
          'title' => 'Noteert reserveringsvragen',
          'text' => 'Noteert wat de gast wil en zet het terugbelverzoek klaar in je overzicht.',
        ),
        2 => 
        array (
