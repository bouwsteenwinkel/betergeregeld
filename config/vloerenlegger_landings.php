...
/**
 * Productverhalen voor de vloerenlegger-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de vloerenbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je vloerenbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een nieuwe vloer wil laten leggen, en laat met een strakke site je strakke vloeren zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je gelegde vloeren in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een vloerenlegger zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je vloeren online',
      'intro' => 'Een vloer verkoopt op uitstraling. Je site laat je gelegde vloeren en tevreden klanten zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'VloerVak',
      'heroTitle' => 'Van egaliseren tot strak gelegde vloer, in één hand',
      'urlLabel' => 'jouw-vloerenbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent gelegde vloeren',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je vloerenbedrijf, naast je werk',
      'sub' => 'Verkoop vloeren, ondervloer en plinten online, met leggen bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast leggen ook vloeren leveren? Klanten bestellen zelf hun vloer, betalen met iDEAL of op rekening en boeken het leggen bij.',
      'brand' => 'VloerVak',
      'heroTitle' => 'Bestel je vloer online en boek het leggen',
      'urlLabel' => 'shop.jouw-vloerenbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-vloerenbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je vloerenbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-vloerenbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je vloerenbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Lig je op je knieën een vloer te leggen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een vloerenbedrijf.',
      'brand' => 'VloerVak',
