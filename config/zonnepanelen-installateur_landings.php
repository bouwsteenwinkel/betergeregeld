...
/**
 * Productverhalen voor de zonnepanelen-installateur-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de zonnepanelenbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je zonnepanelenbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand zonnepanelen wil laten plaatsen, en laat met een strakke site de besparing en je installaties zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je besparing en installaties meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een zonnepanelen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je installaties online',
      'intro' => 'Zonnepanelen draaien om besparing en vertrouwen. Je site laat je installaties, de opbrengst en je service zien, zodat een klant de stap zet en voor jou kiest.',
      'brand' => 'ZonKracht',
      'heroTitle' => 'Zonnepanelen op je dak? Snel geregeld en snel terugverdiend',
      'urlLabel' => 'jouw-zonnepanelenbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent geplaatste installaties',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je zonnepanelenbedrijf, naast je werk',
      'sub' => 'Verkoop panelen, omvormers en toebehoren online, met installatie bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast installeren ook onderdelen leveren? Klanten bestellen zelf panelen en omvormers, betalen met iDEAL of op rekening en boeken installatie bij.',
      'brand' => 'ZonKracht',
      'heroTitle' => 'Bestel zonnepanelen online en boek installatie',
      'urlLabel' => 'shop.jouw-zonnepanelenbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-zonnepanelenbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je zonnepanelenbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-zonnepanelenbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je zonnepanelenbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op een dak panelen te leggen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een zonnepanelenbedrijf.',
      'brand' => 'ZonKracht',
