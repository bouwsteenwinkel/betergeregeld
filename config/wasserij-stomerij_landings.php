...
/**
 * Verkooplaag voor de wasserij-stomerij-triggersite (auto-gegenereerd, mode=retail).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de wasserij. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je wasserij die klanten oplevert',
      'sub' => 'Word gevonden als iemand een wasserij & stomerij zoekt in jouw regio, en laat met een strakke site je assortiment en sfeer zien.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een wasserij & stomerij zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je wasserij',
    ...
    array (
      ...
      'urlLabel' => 'shop.jouw-wasserij.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-wasserij.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je wasserij',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je wasserij die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Een vraag die blijft liggen is een gemiste verkoop. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen over producten en levertijden, dag en nacht. Bekijk hoe dat werkt op een wasserij.',
      'brand' => 'FrisWas',
