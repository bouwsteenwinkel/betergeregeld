...
/**
 * Productverhalen voor de keukenmonteur-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de keukenmontagebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je keukenmontagebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een keuken wil laten monteren, en laat met een strakke site je vakwerk en strakke afwerking zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je gemonteerde keukens in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een keukenmonteur zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je keukenmontage online',
      'intro' => 'Een keuken monteren is precisiewerk. Je site laat je afgeronde keukens en tevreden klanten zien, zodat een opdrachtgever met een gerust hart voor jou kiest.',
      'brand' => 'KeukenVakman',
      'heroTitle' => 'Keuken monteren of aansluiten? Strak en vakkundig geregeld',
      'urlLabel' => 'jouw-keukenmontagebedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent gemonteerde keukens',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je keukenmontagebedrijf, naast je werk',
      'sub' => 'Verkoop kranen, spoelbakken en montagemateriaal online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast monteren ook onderdelen leveren? Klanten bestellen zelf kranen en spoelbakken, betalen met iDEAL en boeken montage bij.',
      'brand' => 'KeukenVakman',
      'heroTitle' => 'Bestel keukenonderdelen online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-keukenmontagebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-keukenmontagebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je keukenmontagebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-keukenmontagebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je keukenmontagebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je een keuken te stellen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een keukenmontagebedrijf.',
      'brand' => 'KeukenVakman',
