...
/**
 * Productverhalen voor de garagedeuren-specialist-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de garagedeurenbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je garagedeurenbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een garagedeur zoekt of een storing heeft, en laat met een strakke site je uitvoeringen en service zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je uitvoeringen en reparatieservice meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een garagedeur zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je deuren en je service online',
      'intro' => 'Een garagedeur kies je op maat. Je site laat je uitvoeringen, montage en reparatieservice zien, zodat een klant precies vindt wat past en voor jou kiest.',
      'brand' => 'DeurVast',
      'heroTitle' => 'Nieuwe garagedeur of storing? Snel en vakkundig geregeld',
      'urlLabel' => 'jouw-garagedeurenbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent geplaatste garagedeuren',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je garagedeurenbedrijf, naast je werk',
      'sub' => 'Verkoop garagedeuren, afstandsbedieningen en onderdelen online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast monteren ook onderdelen leveren? Klanten bestellen zelf afstandsbedieningen en onderdelen, betalen met iDEAL en boeken montage bij.',
      'brand' => 'DeurVast',
      'heroTitle' => 'Bestel garagedeuren en onderdelen online',
      'urlLabel' => 'shop.jouw-garagedeurenbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-garagedeurenbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je garagedeurenbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-garagedeurenbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je garagedeurenbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je een deur af te hangen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een garagedeurenbedrijf.',
      'brand' => 'DeurVast',
