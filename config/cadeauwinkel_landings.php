...
/**
 * Verkooplaag voor de cadeauwinkel-triggersite (auto-gegenereerd, mode=retail).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de cadeauwinkel. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je cadeauwinkel die klanten oplevert',
      'sub' => 'Word gevonden als iemand een cadeauwinkel zoekt in jouw regio, en laat met een strakke site je assortiment en sfeer zien.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een cadeauwinkel zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je cadeauwinkel',
    ...
    array (
      ...
      'urlLabel' => 'shop.jouw-cadeauwinkel.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-cadeauwinkel.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je cadeauwinkel',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-cadeauwinkel.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je cadeauwinkel die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Een vraag die blijft liggen is een gemiste verkoop. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen over producten en levertijden, dag en nacht. Bekijk hoe dat werkt op een cadeauwinkel.',
      'brand' => 'Giftly',
