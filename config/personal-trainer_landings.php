...
/**
 * Verkooplaag voor de personal-trainer-triggersite (auto-gegenereerd, mode=zorg).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de personal-trainingsbedrijf. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je personal-trainingsbedrijf die klanten oplevert',
      'sub' => 'Word gevonden als iemand een personal trainer zoekt in de buurt, en laat met een strakke site zien dat mensen bij jou in goede handen zijn.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je behandelingen en online afspraken meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een personal trainer zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Zorg en aandacht kies je op vertrouwen. Je site laat je aanpak, je team en online afspraken zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'TrainPro',
      'heroTitle' => 'In goede handen: plan eenvoudig een afspraak online',
      'urlLabel' => 'jouw-personal-trainingsbedrijf.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je personal-trainingsbedrijf, naast je werk',
      'sub' => 'Verkoop verzorgingsproducten en cadeaubonnen online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast je behandelingen ook producten aanbieden? Klanten bestellen zelf, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'TrainPro',
      'heroTitle' => 'Bestel producten of een cadeaubon online',
      'urlLabel' => 'shop.jouw-personal-trainingsbedrijf.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Populair',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-personal-trainingsbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je personal-trainingsbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-personal-trainingsbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je personal-trainingsbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je met een klant bezig, dan boekt de beller vaak ergens anders. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een personal-trainingsbedrijf.',
      'brand' => 'TrainPro',
