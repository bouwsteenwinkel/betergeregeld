...
/**
 * Productverhalen voor de paardenfysio-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de paardenfysiopraktijk. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je paardenfysiopraktijk die klanten oplevert',
      'sub' => 'Word gevonden als iemand fysiotherapie voor het paard zoekt, en laat met een strakke site je aanpak en resultaten zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je behandelingen en werkgebied meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een paardenfysio zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je behandelingen en je afspraken online',
      'intro' => 'Paardenfysio kies je op kennis en vertrouwen. Je site laat je aanpak, je resultaten en online afspraken zien, zodat een eigenaar met een gerust hart voor jou kiest.',
      'brand' => 'PaardPuls',
      'heroTitle' => 'Je paard soepel en fit: plan een behandeling online',
      'urlLabel' => 'jouw-paardenfysiopraktijk.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Behandelingen in beeld',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je paardenfysiopraktijk, naast je werk',
      'sub' => 'Verkoop verzorgings- en revalidatieproducten online, met bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast behandelen ook producten leveren? Klanten bestellen zelf verzorging en hulpmiddelen, betalen met iDEAL en kiezen bezorgen of afhalen.',
      'brand' => 'PaardPuls',
      'heroTitle' => 'Bestel verzorgingsproducten online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-paardenfysiopraktijk.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-paardenfysiopraktijk.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je paardenfysiopraktijk',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-paardenfysiopraktijk.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je paardenfysiopraktijk die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je met een paard bezig, dan kun je niet opnemen. De assistent vangt de afspraakaanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een paardenfysiopraktijk.',
      'brand' => 'PaardPuls',
