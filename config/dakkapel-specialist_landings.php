...
/**
 * Productverhalen voor de dakkapel-specialist-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de dakkapelbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je dakkapelbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een dakkapel wil laten plaatsen, en laat met een strakke site zien hoeveel ruimte en licht je erbij maakt.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je geplaatste dakkapellen in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een dakkapel plaatsen zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je dakkapellen online',
      'intro' => 'Een dakkapel is een flinke investering. Je site laat afgeronde dakkapellen en tevreden klanten zien, zodat een opdrachtgever met een gerust hart voor jou kiest.',
      'brand' => 'DakkapelPro',
      'heroTitle' => 'In één dag een dakkapel: meer ruimte en licht',
      'urlLabel' => 'jouw-dakkapelbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent geplaatste dakkapellen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je dakkapelbedrijf, naast je werk',
      'sub' => 'Verkoop dakkapel-opties, ramen en afwerkpakketten online, met plaatsing bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast plaatsen ook opties online aanbieden? Klanten kiezen zelf hun uitvoering, betalen aanbetaling met iDEAL en boeken plaatsing bij.',
      'brand' => 'DakkapelPro',
      'heroTitle' => 'Stel je dakkapel samen en boek plaatsing',
      'urlLabel' => 'shop.jouw-dakkapelbedrijf.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Populaire uitvoeringen',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-dakkapelbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je dakkapelbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-dakkapelbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je dakkapelbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je op een steiger, dan gaat de aanvraag vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een dakkapelbedrijf.',
      'brand' => 'DakkapelPro',
