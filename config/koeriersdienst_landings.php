...
/**
 * Verkooplaag voor de koeriersdienst-triggersite (auto-gegenereerd, mode=bouw).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een weboplossing
 * AAN de koeriersdienst. Copy is generiek-per-sector; verfijn per niche waar nodig.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je koeriersdienst die klussen oplevert',
      'sub' => 'Word gevonden als iemand een koeriersdienst zoekt in jouw regio, en laat met een strakke site je vakwerk en service zien.',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een koeriersdienst zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'urlLabel' => 'jouw-koeriersdienst.nl',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je koeriersdienst, naast je werk',
    ...
    array (
      ...
      'urlLabel' => 'shop.jouw-koeriersdienst.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-koeriersdienst.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je koeriersdienst',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-koeriersdienst.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je koeriersdienst die nooit een aanvraag mist',
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een koeriersdienst.',
      'brand' => 'RitFlits',
