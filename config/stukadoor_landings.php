...
/**
 * Productverhalen voor de stukadoor-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de stukadoorsbedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je stukadoorsbedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand strak stucwerk of sierpleister zoekt, en laat met een strakke site je gladde wanden en plafonds zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je strakke wanden en plafonds in beeld',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een stukadoor zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je stucwerk online',
      'intro' => 'Stucwerk verkoopt op strakheid. Je site laat je gladde wanden, plafonds en sierpleister zien, zodat een klant meteen ziet wat je kunt en voor jou kiest.',
      'brand' => 'StucWerk Pro',
      'heroTitle' => 'Strak stucwerk, glad opgeleverd en klaar voor de verf',
      'urlLabel' => 'jouw-stukadoorsbedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerd stucwerk',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je stukadoorsbedrijf, naast je werk',
      'sub' => 'Verkoop stucmateriaal en gereedschap online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      ...
      'intro' => 'Naast stucen ook materiaal leveren? Klanten bestellen zelf gips en profielen, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'StucWerk Pro',
      'heroTitle' => 'Bestel stucmateriaal online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-stukadoorsbedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-stukadoorsbedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je stukadoorsbedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-stukadoorsbedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je stukadoorsbedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Sta je een wand te stucen, dan kun je niet opnemen. De assistent vangt de aanvraag op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een stukadoorsbedrijf.',
      'brand' => 'StucWerk Pro',
