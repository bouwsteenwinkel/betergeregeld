...
/**
 * Productverhalen voor de apk-keuringsstation-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de apk-keuringsstation. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je apk-keuringsstation die klanten oplevert',
      'sub' => 'Word gevonden als iemand een APK zoekt in de buurt, en laat met een strakke site je tarief, snelheid en online afspraken zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je APK-tarief en online afspraken meteen duidelijk',
        2 => 'Afspraakverzoeken rechtstreeks in je mailbox',
      ),
    ),
    'pains' => 
    array (
      ...
      array (
        ...
        'text' => 'Wie een APK keuring zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je keuringen en je afspraken online',
      'intro' => 'Een APK boek je op gemak en prijs. Je site laat je tarief, je snelle service en online afspraken zien, zodat een klant met een gerust hart voor jou kiest.',
      'brand' => 'KeurVlot',
      'heroTitle' => 'APK nodig? Plan je keuring online en klaar terwijl je wacht',
      'urlLabel' => 'jouw-apk-keuringsstation.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Een kijkje in de werkplaats',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je apk-keuringsstation, naast je werk',
      'sub' => 'Verkoop onderdelen, wissers en lampen online, met montage bij de keuring bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast keuren ook onderdelen leveren? Klanten bestellen zelf wissers en lampen, betalen met iDEAL en laten het bij de APK monteren.',
      'brand' => 'KeurVlot',
      'heroTitle' => 'Bestel onderdelen online, gemonteerd bij je APK',
      'urlLabel' => 'shop.jouw-apk-keuringsstation.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-apk-keuringsstation.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je apk-keuringsstation',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-apk-keuringsstation.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je apk-keuringsstation die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je een auto aan het keuren, dan gaat de bellende klant vaak naar een ander station. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan boekt de klant vaak ergens anders. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen en noteert een terugbelverzoek, dag en nacht. Bekijk hoe dat werkt op een apk-keuringsstation.',
      'brand' => 'KeurVlot',
