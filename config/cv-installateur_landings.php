...
/**
 * Productverhalen voor de cv-installateur-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de installatiebedrijf. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je installatiebedrijf die klussen oplevert',
      'sub' => 'Word gevonden als iemand een cv-ketel of onderhoud zoekt in jouw regio, en laat met een strakke site zien dat je snel, erkend en betrouwbaar bent.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je spoedservice en onderhoud meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een cv-installateur zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      'label' => 'Website',
      'title' => 'Zo kan het worden: je service en je onderhoud online',
      'intro' => 'Verwarming draait om vertrouwen en snelheid. Je site laat je erkenning, je onderhoudsabonnementen en je bereikbaarheid zien, zodat een klant meteen jóu belt.',
      'brand' => 'WarmVak',
      'heroTitle' => 'Cv-ketel vervangen of onderhoud? Snel en erkend geregeld',
      'urlLabel' => 'jouw-installatiebedrijf.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Recent uitgevoerde installaties',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je installatiebedrijf, naast je werk',
      'sub' => 'Verkoop thermostaten, radiatoren en cv-onderdelen online, met montage bij te boeken.',
    ...
    array (
      ...
      'intro' => 'Naast installeren ook onderdelen leveren? Klanten bestellen zelf thermostaten en radiatoren, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'WarmVak',
      'heroTitle' => 'Bestel thermostaten en radiatoren online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-installatiebedrijf.nl',
      'navCta' => 'Winkelmand',
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-installatiebedrijf.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je installatiebedrijf',
    ...
    array (
      ...
      'urlLabel' => 'app.jouw-installatiebedrijf.nl',
      'navCta' => 'Dashboard',
      'heroBtn' => 'Bekijk demo',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je installatiebedrijf die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Lig je onder een ketel, dan gaat de spoedklus vaak naar wie wél opneemt. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Bel je een keer niet op tijd terug, dan is de klus vaak al weg. Een slimme assistent neemt telefoon en chat aan, vraagt door en zet de aanvraag voor je klaar, dag en nacht. Bekijk hoe dat werkt op een installatiebedrijf.',
      'brand' => 'WarmVak',
