...
/**
 * Productverhalen voor de kwekerij-triggersite (verkooplaag).
 * Zelfde opzet als badkamer_landings.php: Beter Geregeld verkoopt een
 * weboplossing AAN de kwekerij. Gegenereerd; zie scratchpad/gen_landings.php.
 */
...
return array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een website voor je kwekerij die klanten oplevert',
      'sub' => 'Word gevonden als iemand planten of bomen zoekt in jouw regio, en laat met een strakke site je assortiment en kwaliteit zien.',
      'note' => 'Gratis en vrijblijvend een voorbeeld van jóuw site, vaak binnen 1 à 2 dagen',
      'usps' => 
      array (
        0 => 'Gevonden in Google in je eigen regio',
        1 => 'Je assortiment en actuele voorraad meteen duidelijk',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Wie een kwekerij zoekt in jouw plaats moet jóu vinden, niet de concurrent die wél bovenaan staat.',
      ),
      2 => 
      array (
    ...
    array (
      ...
      'intro' => 'Planten koop je op het oog. Je site laat je assortiment, foto\'s en prijzen zien, zodat een klant al overtuigd is voordat hij langskomt of bestelt.',
      'brand' => 'GroenGoed',
      'heroTitle' => 'Planten en bomen? Bekijk het assortiment en bestel online',
      'urlLabel' => 'jouw-kwekerij.nl',
      'ctaLabel' => 'Bekijk het volledige voorbeeld',
      'imageSlot' => 'website-preview',
      'galleryLabel' => 'Een greep uit de kwekerij',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een webshop voor je kwekerij',
      'sub' => 'Verkoop planten, bomen en tuinproducten online. Particulier en zakelijk, bezorgen of afhalen.',
    ...
    array (
      'label' => 'Webshop',
      'title' => 'Zo kan het worden: je assortiment 24/7 online',
      'intro' => 'Je kwekerij is 24/7 open. Klanten en hoveniers bestellen zelf planten en bomen, betalen met iDEAL of op rekening en kiezen bezorgen of afhalen.',
      'brand' => 'GroenGoed',
      'heroTitle' => 'Bestel planten en bomen online, bezorgd of afgehaald',
      'urlLabel' => 'shop.jouw-kwekerij.nl',
      'navCta' => 'Winkelmand',
      'heroBtn' => 'In winkelmand',
      'ctaLabel' => 'Bekijk het webshop-voorbeeld',
      'imageSlot' => 'webshop-preview',
      'galleryLabel' => 'Populair in de kwekerij',
      'gallery' => 
      array (
        0 => 
        array (
  ...
  array (
    ...
    array (
      ...
      'urlLabel' => 'mijn.jouw-kwekerij.nl',
      'navCta' => 'Inloggen',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Minder papierwerk in je kwekerij',
  ...
  array (
    ...
    array (
      ...
      'title' => 'Een assistent voor je kwekerij die nooit een aanvraag mist',
    ...
    array (
      ...
      array (
        ...
        'text' => 'Ben je op de kwekerij aan het werk, dan blijft een vraag liggen en gaat de verkoop naar een ander. De assistent vangt dat op.',
      ),
      1 => 
      array (
    ...
    array (
      ...
      'intro' => 'Een vraag die blijft liggen is een gemiste verkoop. Een slimme assistent neemt telefoon en chat aan, beantwoordt vragen over producten en levertijden, dag en nacht. Bekijk hoe dat werkt op een kwekerij.',
      'brand' => 'GroenGoed',
